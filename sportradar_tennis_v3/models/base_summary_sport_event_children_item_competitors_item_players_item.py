...
from ..models.base_summary_sport_event_children_item_competitors_item_players_item_gender import (
    BaseSummarySportEventChildrenItemCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseSummarySportEventChildrenItemCompetitorsItemPlayersItem")


@_attrs_define
class BaseSummarySportEventChildrenItemCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, BaseSummarySportEventChildrenItemCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, BaseSummarySportEventChildrenItemCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = BaseSummarySportEventChildrenItemCompetitorsItemPlayersItemGender(_gender)
        ...
        base_summary_sport_event_children_item_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return base_summary_sport_event_children_item_competitors_item_players_item
