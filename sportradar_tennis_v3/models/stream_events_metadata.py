...
T = TypeVar("T", bound="StreamEventsMetadata")


@_attrs_define
class StreamEventsMetadata:
    """
    Attributes:
        competition_id (str):
        event_id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stream_events_metadata.additional_properties = d
        return stream_events_metadata
