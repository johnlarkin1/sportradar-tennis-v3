...
T = TypeVar("T", bound="GetStreamStatisticsResponse200Type0PayloadStatisticsItemCompetitorsItemStatistics")


@_attrs_define
class GetStreamStatisticsResponse200Type0PayloadStatisticsItemCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_stream_statistics_response_200_type_0_payload_statistics_item_competitors_item_statistics = cls(
            aces=aces,
        ...
        get_stream_statistics_response_200_type_0_payload_statistics_item_competitors_item_statistics.additional_properties = d
        return get_stream_statistics_response_200_type_0_payload_statistics_item_competitors_item_statistics
