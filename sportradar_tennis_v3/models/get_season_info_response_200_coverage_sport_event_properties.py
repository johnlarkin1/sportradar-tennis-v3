...
from ..models.get_season_info_response_200_coverage_sport_event_properties_scores import (
    GetSeasonInfoResponse200CoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSeasonInfoResponse200CoverageSportEventProperties")


@_attrs_define
class GetSeasonInfoResponse200CoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, GetSeasonInfoResponse200CoverageSportEventPropertiesScores]):
    """

    detailed_serve_outcomes: Union[Unset, bool] = UNSET
    enhanced_stats: Union[Unset, bool] = UNSET
    play_by_play: Union[Unset, bool] = UNSET
    scores: Union[Unset, GetSeasonInfoResponse200CoverageSportEventPropertiesScores] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = GetSeasonInfoResponse200CoverageSportEventPropertiesScores(_scores)

        get_season_info_response_200_coverage_sport_event_properties = cls(
        ...
        get_season_info_response_200_coverage_sport_event_properties.additional_properties = d
        return get_season_info_response_200_coverage_sport_event_properties
