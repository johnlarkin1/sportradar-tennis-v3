...
from ..models.ranking_competitor_rankings_item_competitor_players_item_gender import (
    RankingCompetitorRankingsItemCompetitorPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RankingCompetitorRankingsItemCompetitorPlayersItem")


@_attrs_define
class RankingCompetitorRankingsItemCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, RankingCompetitorRankingsItemCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, RankingCompetitorRankingsItemCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = RankingCompetitorRankingsItemCompetitorPlayersItemGender(_gender)
        ...
        ranking_competitor_rankings_item_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return ranking_competitor_rankings_item_competitor_players_item
