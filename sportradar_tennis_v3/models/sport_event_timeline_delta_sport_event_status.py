...
from ..models.sport_event_timeline_delta_sport_event_status_match_status import (
    SportEventTimelineDeltaSportEventStatusMatchStatus,
)
from ..models.sport_event_timeline_delta_sport_event_status_status import SportEventTimelineDeltaSportEventStatusStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_timeline_delta_sport_event_status_game_state import (
        SportEventTimelineDeltaSportEventStatusGameState,
    )
    from ..models.sport_event_timeline_delta_sport_event_status_period_scores_item import (
        SportEventTimelineDeltaSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="SportEventTimelineDeltaSportEventStatus")


@_attrs_define
class SportEventTimelineDeltaSportEventStatus:
    """
    Attributes:
        status (SportEventTimelineDeltaSportEventStatusStatus):
        ...
        game_state (Union[Unset, SportEventTimelineDeltaSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, SportEventTimelineDeltaSportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['SportEventTimelineDeltaSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "SportEventTimelineDeltaSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, SportEventTimelineDeltaSportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["SportEventTimelineDeltaSportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = SportEventTimelineDeltaSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = SportEventTimelineDeltaSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = SportEventTimelineDeltaSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = SportEventTimelineDeltaSportEventStatusPeriodScoresItem.from_dict(
        ...
        sport_event_timeline_delta_sport_event_status = cls(
            status=status,
        ...
        return sport_event_timeline_delta_sport_event_status
