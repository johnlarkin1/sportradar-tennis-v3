...
if TYPE_CHECKING:
    from ..models.get_competitor_summaries_response_200_summaries_item import (
        GetCompetitorSummariesResponse200SummariesItem,
    )


T = TypeVar("T", bound="GetCompetitorSummariesResponse200")


@_attrs_define
class GetCompetitorSummariesResponse200:
    """
    Attributes:
        generated_at (Union[Unset, datetime.datetime]):
        summaries (Union[Unset, List['GetCompetitorSummariesResponse200SummariesItem']]):
    """

    generated_at: Union[Unset, datetime.datetime] = UNSET
    summaries: Union[Unset, List["GetCompetitorSummariesResponse200SummariesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for summaries_item_data in _summaries or []:
            summaries_item = GetCompetitorSummariesResponse200SummariesItem.from_dict(summaries_item_data)

            summaries.append(summaries_item)

        get_competitor_summaries_response_200 = cls(
            generated_at=generated_at,
            summaries=summaries,
        )

        return get_competitor_summaries_response_200
