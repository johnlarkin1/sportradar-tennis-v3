...
T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemSportEventVenue")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemSportEventVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_season_summaries_response_200_summaries_item_sport_event_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return get_season_summaries_response_200_summaries_item_sport_event_venue
