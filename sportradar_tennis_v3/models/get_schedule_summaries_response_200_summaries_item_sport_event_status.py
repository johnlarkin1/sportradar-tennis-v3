...
from ..models.get_schedule_summaries_response_200_summaries_item_sport_event_status_match_status import (
    GetScheduleSummariesResponse200SummariesItemSportEventStatusMatchStatus,
)
from ..models.get_schedule_summaries_response_200_summaries_item_sport_event_status_status import (
    GetScheduleSummariesResponse200SummariesItemSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_schedule_summaries_response_200_summaries_item_sport_event_status_game_state import (
        GetScheduleSummariesResponse200SummariesItemSportEventStatusGameState,
    )
    from ..models.get_schedule_summaries_response_200_summaries_item_sport_event_status_period_scores_item import (
        GetScheduleSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetScheduleSummariesResponse200SummariesItemSportEventStatus")


@_attrs_define
class GetScheduleSummariesResponse200SummariesItemSportEventStatus:
    """
    Attributes:
        status (GetScheduleSummariesResponse200SummariesItemSportEventStatusStatus):
        ...
        game_state (Union[Unset, GetScheduleSummariesResponse200SummariesItemSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetScheduleSummariesResponse200SummariesItemSportEventStatusMatchStatus]):
        period_scores (Union[Unset,
            List['GetScheduleSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetScheduleSummariesResponse200SummariesItemSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, GetScheduleSummariesResponse200SummariesItemSportEventStatusMatchStatus] = UNSET
    period_scores: Union[
        Unset, List["GetScheduleSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetScheduleSummariesResponse200SummariesItemSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetScheduleSummariesResponse200SummariesItemSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetScheduleSummariesResponse200SummariesItemSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = GetScheduleSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem.from_dict(
        ...
        get_schedule_summaries_response_200_summaries_item_sport_event_status = cls(
            status=status,
        ...
        return get_schedule_summaries_response_200_summaries_item_sport_event_status
