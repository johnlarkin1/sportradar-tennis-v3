...
if TYPE_CHECKING:
    from ..models.standing_group_comments_item import StandingGroupCommentsItem
    from ..models.standing_group_stage import StandingGroupStage
    from ..models.standing_group_standings_item import StandingGroupStandingsItem
...
class StandingGroup:
    ...
    Attributes:
        ...
        name (str):
        comments (Union[Unset, List['StandingGroupCommentsItem']]):
        group_name (Union[Unset, str]):
        live (Union[Unset, bool]):
        parent_group_id (Union[Unset, str]):
        stage (Union[Unset, StandingGroupStage]):
        standings (Union[Unset, List['StandingGroupStandingsItem']]):
    """

    id: str
    name: str
    comments: Union[Unset, List["StandingGroupCommentsItem"]] = UNSET
    group_name: Union[Unset, str] = UNSET
    live: Union[Unset, bool] = UNSET
    parent_group_id: Union[Unset, str] = UNSET
    stage: Union[Unset, "StandingGroupStage"] = UNSET
    standings: Union[Unset, List["StandingGroupStandingsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for comments_item_data in _comments or []:
            comments_item = StandingGroupCommentsItem.from_dict(comments_item_data)
        ...
        if isinstance(_stage, Unset):
            ...
            stage = StandingGroupStage.from_dict(_stage)

        standings = []
        _standings = d.pop("standings", UNSET)
        for standings_item_data in _standings or []:
            standings_item = StandingGroupStandingsItem.from_dict(standings_item_data)
