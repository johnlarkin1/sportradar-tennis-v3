...
T = TypeVar("T", bound="SeasonBracketsGroupCupRoundsItemSportEventsItem")


@_attrs_define
class SeasonBracketsGroupCupRoundsItemSportEventsItem:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        season_brackets_group_cup_rounds_item_sport_events_item = cls(
            id=id,
            start_time=start_time,
            start_time_confirmed=start_time_confirmed,
            order=order,
        ...
        return season_brackets_group_cup_rounds_item_sport_events_item
