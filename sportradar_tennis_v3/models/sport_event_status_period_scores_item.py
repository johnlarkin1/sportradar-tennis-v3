...
from ..models.sport_event_status_period_scores_item_type import SportEventStatusPeriodScoresItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventStatusPeriodScoresItem")


@_attrs_define
class SportEventStatusPeriodScoresItem:
    """
    Attributes:
        away_score (int):
        home_score (int):
        ...
        type (Union[Unset, SportEventStatusPeriodScoresItemType]):
    """
    ...
    type: Union[Unset, SportEventStatusPeriodScoresItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = SportEventStatusPeriodScoresItemType(_type)

        sport_event_status_period_scores_item = cls(
            away_score=away_score,
            home_score=home_score,
        ...
        return sport_event_status_period_scores_item
