...
T = TypeVar("T", bound="SeasonBracketsCupRoundSportEventsItem")


@_attrs_define
class SeasonBracketsCupRoundSportEventsItem:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        season_brackets_cup_round_sport_events_item = cls(
            id=id,
            start_time=start_time,
            start_time_confirmed=start_time_confirmed,
            order=order,
        ...
        return season_brackets_cup_round_sport_events_item
