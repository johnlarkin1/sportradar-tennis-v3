...
from ..models.ranking_competitor_rankings_item_competitor_gender import RankingCompetitorRankingsItemCompetitorGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ranking_competitor_rankings_item_competitor_players_item import (
        RankingCompetitorRankingsItemCompetitorPlayersItem,
    )


T = TypeVar("T", bound="RankingCompetitorRankingsItemCompetitor")


@_attrs_define
class RankingCompetitorRankingsItemCompetitor:
    """
    Attributes:
        ...
        gender (Union[Unset, RankingCompetitorRankingsItemCompetitorGender]):
        players (Union[Unset, List['RankingCompetitorRankingsItemCompetitorPlayersItem']]):
    ...
    gender: Union[Unset, RankingCompetitorRankingsItemCompetitorGender] = UNSET
    players: Union[Unset, List["RankingCompetitorRankingsItemCompetitorPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = RankingCompetitorRankingsItemCompetitorGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = RankingCompetitorRankingsItemCompetitorPlayersItem.from_dict(players_item_data)
        ...
        ranking_competitor_rankings_item_competitor = cls(
            id=id,
            name=name,
        ...
        ranking_competitor_rankings_item_competitor.additional_properties = d
        return ranking_competitor_rankings_item_competitor
