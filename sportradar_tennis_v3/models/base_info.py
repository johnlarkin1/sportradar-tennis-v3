...
from ..models.base_info_competition_status import BaseInfoCompetitionStatus
...
class BaseInfo:
    """
    Attributes:
        competition_status (Union[Unset, BaseInfoCompetitionStatus]):
        venue_reduced_capacity (Union[Unset, bool]):
        venue_reduced_capacity_max (Union[Unset, int]):
    """

    competition_status: Union[Unset, BaseInfoCompetitionStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competition_status, Unset):
            ...
            competition_status = BaseInfoCompetitionStatus(_competition_status)
