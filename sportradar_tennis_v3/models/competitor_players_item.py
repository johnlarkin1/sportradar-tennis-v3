...
from ..models.competitor_players_item_gender import CompetitorPlayersItemGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompetitorPlayersItem")


@_attrs_define
class CompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, CompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, CompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = CompetitorPlayersItemGender(_gender)
        ...
        return competitor_players_item
