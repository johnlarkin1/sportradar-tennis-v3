...
from ..models.summary_sport_event_sport_event_context_round_name import SummarySportEventSportEventContextRoundName
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummarySportEventSportEventContextRound")


@_attrs_define
class SummarySportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, SummarySportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, SummarySportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = SummarySportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        summary_sport_event_sport_event_context_round = cls(
        ...
        return summary_sport_event_sport_event_context_round
