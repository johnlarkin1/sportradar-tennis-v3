...
from ..models.sport_event_probability_sport_event_status_match_status import (
    SportEventProbabilitySportEventStatusMatchStatus,
)
from ..models.sport_event_probability_sport_event_status_status import SportEventProbabilitySportEventStatusStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_probability_sport_event_status_game_state import (
        SportEventProbabilitySportEventStatusGameState,
    )
    from ..models.sport_event_probability_sport_event_status_period_scores_item import (
        SportEventProbabilitySportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="SportEventProbabilitySportEventStatus")


@_attrs_define
class SportEventProbabilitySportEventStatus:
    """
    Attributes:
        status (SportEventProbabilitySportEventStatusStatus):
        ...
        game_state (Union[Unset, SportEventProbabilitySportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, SportEventProbabilitySportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['SportEventProbabilitySportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "SportEventProbabilitySportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, SportEventProbabilitySportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["SportEventProbabilitySportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = SportEventProbabilitySportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = SportEventProbabilitySportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = SportEventProbabilitySportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = SportEventProbabilitySportEventStatusPeriodScoresItem.from_dict(
        ...
        sport_event_probability_sport_event_status = cls(
            status=status,
        ...
        return sport_event_probability_sport_event_status
