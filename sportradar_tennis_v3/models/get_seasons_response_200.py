...
if TYPE_CHECKING:
    from ..models.get_seasons_response_200_seasons_item import GetSeasonsResponse200SeasonsItem


T = TypeVar("T", bound="GetSeasonsResponse200")


@_attrs_define
class GetSeasonsResponse200:
    """
    Attributes:
        generated_at (Union[Unset, datetime.datetime]):
        seasons (Union[Unset, List['GetSeasonsResponse200SeasonsItem']]):
    """

    generated_at: Union[Unset, datetime.datetime] = UNSET
    seasons: Union[Unset, List["GetSeasonsResponse200SeasonsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for seasons_item_data in _seasons or []:
            seasons_item = GetSeasonsResponse200SeasonsItem.from_dict(seasons_item_data)

            seasons.append(seasons_item)

        get_seasons_response_200 = cls(
            generated_at=generated_at,
            seasons=seasons,
        )

        return get_seasons_response_200
