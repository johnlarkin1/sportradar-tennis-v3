...
if TYPE_CHECKING:
    from ..models.standing_groups_item import StandingGroupsItem
...
class Standing:
    ...
    Attributes:
        type (StandingType):
        groups (Union[Unset, List['StandingGroupsItem']]):
        round_ (Union[Unset, int]):
        tie_break_rule (Union[Unset, str]):
    """

    type: StandingType
    groups: Union[Unset, List["StandingGroupsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = StandingGroupsItem.from_dict(groups_item_data)
