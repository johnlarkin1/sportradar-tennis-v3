...
T = TypeVar("T", bound="GetSportEventSummaryResponse200SportEventVenue")


@_attrs_define
class GetSportEventSummaryResponse200SportEventVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_sport_event_summary_response_200_sport_event_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return get_sport_event_summary_response_200_sport_event_venue
