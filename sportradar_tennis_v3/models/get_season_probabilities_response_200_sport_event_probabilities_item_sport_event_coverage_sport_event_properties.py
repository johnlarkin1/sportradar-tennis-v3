...
from ..models.get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_coverage_sport_event_properties_scores import (
    GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar(
    "T", bound="GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventCoverageSportEventProperties"
)


@_attrs_define
class GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventCoverageSportEventProperties:
    """
    Attributes:
    ...
    scores: Union[
        Unset, GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventCoverageSportEventPropertiesScores
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventCoverageSportEventPropertiesScores(
                _scores
            )

        get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_coverage_sport_event_properties = cls(
        ...
        get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_coverage_sport_event_properties.additional_properties = d
        return get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_coverage_sport_event_properties
