...
if TYPE_CHECKING:
    from ..models.sport_event_timeline_delta_sport_event_status import SportEventTimelineDeltaSportEventStatus
    from ..models.sport_event_timeline_delta_timeline_item import SportEventTimelineDeltaTimelineItem
...
class SportEventTimelineDelta:
    ...
    Attributes:
        ...
        sport_event_status (Union[Unset, SportEventTimelineDeltaSportEventStatus]):
        start_time (Union[Unset, datetime.datetime]):
        timeline (Union[Unset, List['SportEventTimelineDeltaTimelineItem']]):
    """

    id: Union[Unset, str] = UNSET
    sport_event_status: Union[Unset, "SportEventTimelineDeltaSportEventStatus"] = UNSET
    start_time: Union[Unset, datetime.datetime] = UNSET
    timeline: Union[Unset, List["SportEventTimelineDeltaTimelineItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sport_event_status, Unset):
            ...
            sport_event_status = SportEventTimelineDeltaSportEventStatus.from_dict(_sport_event_status)
        ...
        for timeline_item_data in _timeline or []:
            timeline_item = SportEventTimelineDeltaTimelineItem.from_dict(timeline_item_data)
