...
from ..models.sport_event_probability_sport_event_sport_event_context_round_name import (
    SportEventProbabilitySportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventProbabilitySportEventSportEventContextRound")


@_attrs_define
class SportEventProbabilitySportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, SportEventProbabilitySportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, SportEventProbabilitySportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = SportEventProbabilitySportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        sport_event_probability_sport_event_sport_event_context_round = cls(
        ...
        return sport_event_probability_sport_event_sport_event_context_round
