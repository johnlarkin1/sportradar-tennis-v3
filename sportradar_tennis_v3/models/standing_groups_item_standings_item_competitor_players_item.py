...
from ..models.standing_groups_item_standings_item_competitor_players_item_gender import (
    StandingGroupsItemStandingsItemCompetitorPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StandingGroupsItemStandingsItemCompetitorPlayersItem")


@_attrs_define
class StandingGroupsItemStandingsItemCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, StandingGroupsItemStandingsItemCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, StandingGroupsItemStandingsItemCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = StandingGroupsItemStandingsItemCompetitorPlayersItemGender(_gender)
        ...
        standing_groups_item_standings_item_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return standing_groups_item_standings_item_competitor_players_item
