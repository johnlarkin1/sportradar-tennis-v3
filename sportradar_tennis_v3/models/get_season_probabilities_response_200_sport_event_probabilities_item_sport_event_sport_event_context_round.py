...
from ..models.get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_sport_event_context_round_name import (
    GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventSportEventContextRound")


@_attrs_define
class GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventSportEventContextRound:
    """
    Attributes:
    ...
    name: Union[
        Unset, GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventSportEventContextRoundName
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventSportEventContextRoundName(
                _name
            )
        ...
        get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_sport_event_context_round = (
            cls(
