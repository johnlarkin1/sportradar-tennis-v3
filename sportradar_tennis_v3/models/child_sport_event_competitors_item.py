...
from ..models.child_sport_event_competitors_item_gender import ChildSportEventCompetitorsItemGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.child_sport_event_competitors_item_players_item import ChildSportEventCompetitorsItemPlayersItem


T = TypeVar("T", bound="ChildSportEventCompetitorsItem")


@_attrs_define
class ChildSportEventCompetitorsItem:
    """
    Attributes:
        ...
        gender (Union[Unset, ChildSportEventCompetitorsItemGender]):
        players (Union[Unset, List['ChildSportEventCompetitorsItemPlayersItem']]):
    ...
    gender: Union[Unset, ChildSportEventCompetitorsItemGender] = UNSET
    players: Union[Unset, List["ChildSportEventCompetitorsItemPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = ChildSportEventCompetitorsItemGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = ChildSportEventCompetitorsItemPlayersItem.from_dict(players_item_data)
        ...
        child_sport_event_competitors_item = cls(
            id=id,
            name=name,
        ...
        child_sport_event_competitors_item.additional_properties = d
        return child_sport_event_competitors_item
