...
from ..models.double_competitor_player_gender import DoubleCompetitorPlayerGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="DoubleCompetitorPlayer")


@_attrs_define
class DoubleCompetitorPlayer:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, DoubleCompetitorPlayerGender]):
    ...
    gender: Union[Unset, DoubleCompetitorPlayerGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = DoubleCompetitorPlayerGender(_gender)
        ...
        return double_competitor_player
