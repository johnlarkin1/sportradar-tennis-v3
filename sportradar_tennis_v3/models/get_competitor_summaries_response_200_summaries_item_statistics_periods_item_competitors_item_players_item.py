...
from ..models.get_competitor_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_players_item_gender import (
    GetCompetitorSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitorSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemPlayersItem")


@_attrs_define
class GetCompetitorSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
    ...
    gender: Union[
        Unset, GetCompetitorSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemPlayersItemGender
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_competitor_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_players_item = (
            cls(
                id=id,
                name=name,
