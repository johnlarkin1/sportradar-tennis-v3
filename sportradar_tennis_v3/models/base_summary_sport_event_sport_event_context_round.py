...
from ..models.base_summary_sport_event_sport_event_context_round_name import (
    BaseSummarySportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseSummarySportEventSportEventContextRound")


@_attrs_define
class BaseSummarySportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, BaseSummarySportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, BaseSummarySportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = BaseSummarySportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        base_summary_sport_event_sport_event_context_round = cls(
        ...
        return base_summary_sport_event_sport_event_context_round
