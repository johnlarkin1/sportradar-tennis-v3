...
from ..models.standing_competitor_competitor_gender import StandingCompetitorCompetitorGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.standing_competitor_competitor_players_item import StandingCompetitorCompetitorPlayersItem


T = TypeVar("T", bound="StandingCompetitorCompetitor")


@_attrs_define
class StandingCompetitorCompetitor:
    """
    Attributes:
        ...
        gender (Union[Unset, StandingCompetitorCompetitorGender]):
        players (Union[Unset, List['StandingCompetitorCompetitorPlayersItem']]):
    ...
    gender: Union[Unset, StandingCompetitorCompetitorGender] = UNSET
    players: Union[Unset, List["StandingCompetitorCompetitorPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = StandingCompetitorCompetitorGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = StandingCompetitorCompetitorPlayersItem.from_dict(players_item_data)
        ...
        standing_competitor_competitor = cls(
            id=id,
            name=name,
        ...
        standing_competitor_competitor.additional_properties = d
        return standing_competitor_competitor
