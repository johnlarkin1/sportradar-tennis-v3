...
from ..models.base_sport_event_context_round_name import BaseSportEventContextRoundName
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseSportEventContextRound")


@_attrs_define
class BaseSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, BaseSportEventContextRoundName]):
    ...
    name: Union[Unset, BaseSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = BaseSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        base_sport_event_context_round = cls(
        ...
        return base_sport_event_context_round
