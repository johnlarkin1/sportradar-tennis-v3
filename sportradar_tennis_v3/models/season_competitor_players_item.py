...
from ..models.season_competitor_players_item_gender import SeasonCompetitorPlayersItemGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonCompetitorPlayersItem")


@_attrs_define
class SeasonCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SeasonCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, SeasonCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SeasonCompetitorPlayersItemGender(_gender)
        ...
        season_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return season_competitor_players_item
