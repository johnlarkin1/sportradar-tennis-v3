...
T = TypeVar("T", bound="SummaryStatisticsPeriodsItemCompetitorsItemStatistics")


@_attrs_define
class SummaryStatisticsPeriodsItemCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        summary_statistics_periods_item_competitors_item_statistics = cls(
            aces=aces,
        ...
        summary_statistics_periods_item_competitors_item_statistics.additional_properties = d
        return summary_statistics_periods_item_competitors_item_statistics
