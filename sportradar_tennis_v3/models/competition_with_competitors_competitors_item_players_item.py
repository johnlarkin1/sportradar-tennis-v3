...
from ..models.competition_with_competitors_competitors_item_players_item_gender import (
    CompetitionWithCompetitorsCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompetitionWithCompetitorsCompetitorsItemPlayersItem")


@_attrs_define
class CompetitionWithCompetitorsCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, CompetitionWithCompetitorsCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, CompetitionWithCompetitorsCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = CompetitionWithCompetitorsCompetitorsItemPlayersItemGender(_gender)
        ...
        competition_with_competitors_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return competition_with_competitors_competitors_item_players_item
