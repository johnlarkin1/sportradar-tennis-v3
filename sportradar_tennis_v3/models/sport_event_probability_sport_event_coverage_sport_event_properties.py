...
from ..models.sport_event_probability_sport_event_coverage_sport_event_properties_scores import (
    SportEventProbabilitySportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventProbabilitySportEventCoverageSportEventProperties")


@_attrs_define
class SportEventProbabilitySportEventCoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, SportEventProbabilitySportEventCoverageSportEventPropertiesScores]):
    """

    detailed_serve_outcomes: Union[Unset, bool] = UNSET
    enhanced_stats: Union[Unset, bool] = UNSET
    play_by_play: Union[Unset, bool] = UNSET
    scores: Union[Unset, SportEventProbabilitySportEventCoverageSportEventPropertiesScores] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = SportEventProbabilitySportEventCoverageSportEventPropertiesScores(_scores)

        sport_event_probability_sport_event_coverage_sport_event_properties = cls(
        ...
        sport_event_probability_sport_event_coverage_sport_event_properties.additional_properties = d
        return sport_event_probability_sport_event_coverage_sport_event_properties
