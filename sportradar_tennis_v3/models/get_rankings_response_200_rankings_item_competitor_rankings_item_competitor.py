...
T = TypeVar("T", bound="GetRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor")


@_attrs_define
class GetRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_rankings_response_200_rankings_item_competitor_rankings_item_competitor = cls(
            id=id,
            name=name,
        ...
        get_rankings_response_200_rankings_item_competitor_rankings_item_competitor.additional_properties = d
        return get_rankings_response_200_rankings_item_competitor_rankings_item_competitor
