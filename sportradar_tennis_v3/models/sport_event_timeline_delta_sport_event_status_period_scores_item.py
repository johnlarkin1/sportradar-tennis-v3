...
from ..models.sport_event_timeline_delta_sport_event_status_period_scores_item_type import (
    SportEventTimelineDeltaSportEventStatusPeriodScoresItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventTimelineDeltaSportEventStatusPeriodScoresItem")


@_attrs_define
class SportEventTimelineDeltaSportEventStatusPeriodScoresItem:
    """
    Attributes:
        away_score (int):
        home_score (int):
        ...
        type (Union[Unset, SportEventTimelineDeltaSportEventStatusPeriodScoresItemType]):
    """
    ...
    type: Union[Unset, SportEventTimelineDeltaSportEventStatusPeriodScoresItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = SportEventTimelineDeltaSportEventStatusPeriodScoresItemType(_type)

        sport_event_timeline_delta_sport_event_status_period_scores_item = cls(
            away_score=away_score,
            home_score=home_score,
        ...
        return sport_event_timeline_delta_sport_event_status_period_scores_item
