...
from ..models.winner_last_season_competitor_gender import WinnerLastSeasonCompetitorGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.winner_last_season_competitor_players_item import WinnerLastSeasonCompetitorPlayersItem


T = TypeVar("T", bound="WinnerLastSeasonCompetitor")


@_attrs_define
class WinnerLastSeasonCompetitor:
    """
    Attributes:
        ...
        gender (Union[Unset, WinnerLastSeasonCompetitorGender]):
        players (Union[Unset, List['WinnerLastSeasonCompetitorPlayersItem']]):
    ...
    gender: Union[Unset, WinnerLastSeasonCompetitorGender] = UNSET
    players: Union[Unset, List["WinnerLastSeasonCompetitorPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = WinnerLastSeasonCompetitorGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = WinnerLastSeasonCompetitorPlayersItem.from_dict(players_item_data)
        ...
        winner_last_season_competitor = cls(
            id=id,
            name=name,
        ...
        winner_last_season_competitor.additional_properties = d
        return winner_last_season_competitor
