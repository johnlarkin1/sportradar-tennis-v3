...
if TYPE_CHECKING:
    from ..models.get_sport_event_summary_response_200_sport_event_coverage_sport_event_properties import (
        GetSportEventSummaryResponse200SportEventCoverageSportEventProperties,
    )


T = TypeVar("T", bound="GetSportEventSummaryResponse200SportEventCoverage")


@_attrs_define
class GetSportEventSummaryResponse200SportEventCoverage:
    ...
    sport_event_properties. When type="competition" you will get sport_event_properties and competition_properties.
        ...
        Attributes:
            sport_event_properties (Union[Unset, GetSportEventSummaryResponse200SportEventCoverageSportEventProperties]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sport_event_properties, Unset):
            ...
            sport_event_properties = GetSportEventSummaryResponse200SportEventCoverageSportEventProperties.from_dict(
                _sport_event_properties
            )

        type = d.pop("type", UNSET)

        get_sport_event_summary_response_200_sport_event_coverage = cls(
            sport_event_properties=sport_event_properties,
            type=type,
        )

        return get_sport_event_summary_response_200_sport_event_coverage
