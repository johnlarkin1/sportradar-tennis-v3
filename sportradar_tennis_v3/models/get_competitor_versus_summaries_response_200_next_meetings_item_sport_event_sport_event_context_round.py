...
from ..models.get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_sport_event_context_round_name import (
    GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventSportEventContextRound")


@_attrs_define
class GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventSportEventContextRound:
    """
    Attributes:
    ...
    name: Union[Unset, GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventSportEventContextRoundName] = (
        UNSET
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_sport_event_context_round = cls(
        ...
        return get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_sport_event_context_round
