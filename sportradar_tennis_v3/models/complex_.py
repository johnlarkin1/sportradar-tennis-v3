...
if TYPE_CHECKING:
    from ..models.complex_venues_item import ComplexVenuesItem
...
class Complex:
    ...
    Attributes:
        ...
        name (str):
        venues (Union[Unset, List['ComplexVenuesItem']]):
    """

    id: str
    name: str
    venues: Union[Unset, List["ComplexVenuesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for venues_item_data in _venues or []:
            venues_item = ComplexVenuesItem.from_dict(venues_item_data)
