...
T = TypeVar("T", bound="SingleRankingCompetitorRankingsItemCompetitor")


@_attrs_define
class SingleRankingCompetitorRankingsItemCompetitor:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        single_ranking_competitor_rankings_item_competitor = cls(
            id=id,
            name=name,
        ...
        single_ranking_competitor_rankings_item_competitor.additional_properties = d
        return single_ranking_competitor_rankings_item_competitor
