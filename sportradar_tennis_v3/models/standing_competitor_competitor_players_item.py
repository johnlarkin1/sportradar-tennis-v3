...
from ..models.standing_competitor_competitor_players_item_gender import StandingCompetitorCompetitorPlayersItemGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="StandingCompetitorCompetitorPlayersItem")


@_attrs_define
class StandingCompetitorCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, StandingCompetitorCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, StandingCompetitorCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = StandingCompetitorCompetitorPlayersItemGender(_gender)
        ...
        standing_competitor_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return standing_competitor_competitor_players_item
