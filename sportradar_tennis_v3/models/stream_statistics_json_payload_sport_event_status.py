...
from ..models.stream_statistics_json_payload_sport_event_status_match_status import (
    StreamStatisticsJsonPayloadSportEventStatusMatchStatus,
)
from ..models.stream_statistics_json_payload_sport_event_status_status import (
    StreamStatisticsJsonPayloadSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.stream_statistics_json_payload_sport_event_status_game_state import (
        StreamStatisticsJsonPayloadSportEventStatusGameState,
    )
    from ..models.stream_statistics_json_payload_sport_event_status_period_scores_item import (
        StreamStatisticsJsonPayloadSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="StreamStatisticsJsonPayloadSportEventStatus")


@_attrs_define
class StreamStatisticsJsonPayloadSportEventStatus:
    """
    Attributes:
        status (StreamStatisticsJsonPayloadSportEventStatusStatus):
        ...
        game_state (Union[Unset, StreamStatisticsJsonPayloadSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, StreamStatisticsJsonPayloadSportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['StreamStatisticsJsonPayloadSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "StreamStatisticsJsonPayloadSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, StreamStatisticsJsonPayloadSportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["StreamStatisticsJsonPayloadSportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = StreamStatisticsJsonPayloadSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = StreamStatisticsJsonPayloadSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = StreamStatisticsJsonPayloadSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = StreamStatisticsJsonPayloadSportEventStatusPeriodScoresItem.from_dict(
        ...
        stream_statistics_json_payload_sport_event_status = cls(
            status=status,
        ...
        return stream_statistics_json_payload_sport_event_status
