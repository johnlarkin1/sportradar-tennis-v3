...
if TYPE_CHECKING:
    from ..models.season_stage_groups_item_competitors_item import SeasonStageGroupsItemCompetitorsItem


T = TypeVar("T", bound="SeasonStageGroupsItem")


@_attrs_define
class SeasonStageGroupsItem:
    """
    Attributes:
        id (str):
        name (str):
        competitors (Union[Unset, List['SeasonStageGroupsItemCompetitorsItem']]):
    ...
    id: str
    name: str
    competitors: Union[Unset, List["SeasonStageGroupsItemCompetitorsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for competitors_item_data in _competitors or []:
            competitors_item = SeasonStageGroupsItemCompetitorsItem.from_dict(competitors_item_data)
        ...
        return season_stage_groups_item
