...
from ..models.base_summary_sport_event_status_match_status import BaseSummarySportEventStatusMatchStatus
from ..models.base_summary_sport_event_status_status import BaseSummarySportEventStatusStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.base_summary_sport_event_status_game_state import BaseSummarySportEventStatusGameState
    from ..models.base_summary_sport_event_status_period_scores_item import BaseSummarySportEventStatusPeriodScoresItem


T = TypeVar("T", bound="BaseSummarySportEventStatus")


@_attrs_define
class BaseSummarySportEventStatus:
    """
    Attributes:
        status (BaseSummarySportEventStatusStatus):
        ...
        game_state (Union[Unset, BaseSummarySportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, BaseSummarySportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['BaseSummarySportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "BaseSummarySportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, BaseSummarySportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["BaseSummarySportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.base_summary_sport_event_status_game_state import BaseSummarySportEventStatusGameState
        from ..models.base_summary_sport_event_status_period_scores_item import (
            BaseSummarySportEventStatusPeriodScoresItem,
        )

        d = src_dict.copy()
        status = BaseSummarySportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = BaseSummarySportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = BaseSummarySportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = BaseSummarySportEventStatusPeriodScoresItem.from_dict(period_scores_item_data)
        ...
        base_summary_sport_event_status = cls(
            status=status,
        ...
        return base_summary_sport_event_status
