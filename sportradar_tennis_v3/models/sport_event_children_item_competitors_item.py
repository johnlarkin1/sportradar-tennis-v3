...
from ..models.sport_event_children_item_competitors_item_gender import SportEventChildrenItemCompetitorsItemGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_children_item_competitors_item_players_item import (
        SportEventChildrenItemCompetitorsItemPlayersItem,
    )


T = TypeVar("T", bound="SportEventChildrenItemCompetitorsItem")


@_attrs_define
class SportEventChildrenItemCompetitorsItem:
    """
    Attributes:
        ...
        gender (Union[Unset, SportEventChildrenItemCompetitorsItemGender]):
        players (Union[Unset, List['SportEventChildrenItemCompetitorsItemPlayersItem']]):
    ...
    gender: Union[Unset, SportEventChildrenItemCompetitorsItemGender] = UNSET
    players: Union[Unset, List["SportEventChildrenItemCompetitorsItemPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SportEventChildrenItemCompetitorsItemGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = SportEventChildrenItemCompetitorsItemPlayersItem.from_dict(players_item_data)
        ...
        sport_event_children_item_competitors_item = cls(
            id=id,
            name=name,
        ...
        sport_event_children_item_competitors_item.additional_properties = d
        return sport_event_children_item_competitors_item
