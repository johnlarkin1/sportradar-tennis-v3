...
from ..models.sport_event_status_match_status import SportEventStatusMatchStatus
from ..models.sport_event_status_status import SportEventStatusStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_status_game_state import SportEventStatusGameState
    from ..models.sport_event_status_period_scores_item import SportEventStatusPeriodScoresItem


T = TypeVar("T", bound="SportEventStatus")
...
class SportEventStatus:
    ...
    Attributes:
        ...
        game_state (Union[Unset, SportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, SportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['SportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "SportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, SportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["SportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = SportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = SportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = SportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = SportEventStatusPeriodScoresItem.from_dict(period_scores_item_data)
