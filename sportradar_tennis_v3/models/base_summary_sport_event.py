...
from ..models.base_summary_sport_event_type import BaseSummarySportEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.base_summary_sport_event_children_item import BaseSummarySportEventChildrenItem
    from ..models.base_summary_sport_event_competitors_item import BaseSummarySportEventCompetitorsItem
    from ..models.base_summary_sport_event_coverage import BaseSummarySportEventCoverage
    from ..models.base_summary_sport_event_sport_event_context import BaseSummarySportEventSportEventContext
    from ..models.base_summary_sport_event_venue import BaseSummarySportEventVenue


T = TypeVar("T", bound="BaseSummarySportEvent")


@_attrs_define
class BaseSummarySportEvent:
    """
    Attributes:
        id (str):
        start_time (datetime.datetime): Scheduled event start
        start_time_confirmed (bool):
        children (Union[Unset, List['BaseSummarySportEventChildrenItem']]):
        competitors (Union[Unset, List['BaseSummarySportEventCompetitorsItem']]):
        coverage (Union[Unset, BaseSummarySportEventCoverage]): Describes the expected coverage for different entities
        ...
        sport_event_context (Union[Unset, BaseSummarySportEventSportEventContext]):
        type (Union[Unset, BaseSummarySportEventType]):
        venue (Union[Unset, BaseSummarySportEventVenue]):
    """

    id: str
    start_time: datetime.datetime
    start_time_confirmed: bool
    children: Union[Unset, List["BaseSummarySportEventChildrenItem"]] = UNSET
    competitors: Union[Unset, List["BaseSummarySportEventCompetitorsItem"]] = UNSET
    coverage: Union[Unset, "BaseSummarySportEventCoverage"] = UNSET
    estimated: Union[Unset, bool] = UNSET
    parent_id: Union[Unset, str] = UNSET
    replaced_by: Union[Unset, str] = UNSET
    resume_time: Union[Unset, datetime.datetime] = UNSET
    sport_event_context: Union[Unset, "BaseSummarySportEventSportEventContext"] = UNSET
    type: Union[Unset, BaseSummarySportEventType] = UNSET
    venue: Union[Unset, "BaseSummarySportEventVenue"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for children_item_data in _children or []:
            children_item = BaseSummarySportEventChildrenItem.from_dict(children_item_data)
        ...
        for competitors_item_data in _competitors or []:
            competitors_item = BaseSummarySportEventCompetitorsItem.from_dict(competitors_item_data)

            competitors.append(competitors_item)

        _coverage = d.pop("coverage", UNSET)
        coverage: Union[Unset, BaseSummarySportEventCoverage]
        if isinstance(_coverage, Unset):
            coverage = UNSET
        else:
            coverage = BaseSummarySportEventCoverage.from_dict(_coverage)
        ...
        if isinstance(_sport_event_context, Unset):
            ...
            sport_event_context = BaseSummarySportEventSportEventContext.from_dict(_sport_event_context)
        ...
        if isinstance(_type, Unset):
            ...
            type = BaseSummarySportEventType(_type)
        ...
        if isinstance(_venue, Unset):
            ...
            venue = BaseSummarySportEventVenue.from_dict(_venue)

        base_summary_sport_event = cls(
            id=id,
            start_time=start_time,
            start_time_confirmed=start_time_confirmed,
            children=children,
        ...
        return base_summary_sport_event
