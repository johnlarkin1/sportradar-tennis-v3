...
from ..models.get_schedule_live_summaries_response_200_summaries_item_sport_event_sport_event_context_round_name import (
    GetScheduleLiveSummariesResponse200SummariesItemSportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetScheduleLiveSummariesResponse200SummariesItemSportEventSportEventContextRound")


@_attrs_define
class GetScheduleLiveSummariesResponse200SummariesItemSportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, GetScheduleLiveSummariesResponse200SummariesItemSportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, GetScheduleLiveSummariesResponse200SummariesItemSportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetScheduleLiveSummariesResponse200SummariesItemSportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        get_schedule_live_summaries_response_200_summaries_item_sport_event_sport_event_context_round = cls(
        ...
        return get_schedule_live_summaries_response_200_summaries_item_sport_event_sport_event_context_round
