...
from ..models.get_season_info_response_200_season_info_competition_status import (
    GetSeasonInfoResponse200SeasonInfoCompetitionStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSeasonInfoResponse200SeasonInfo")


@_attrs_define
class GetSeasonInfoResponse200SeasonInfo:
    """
    Attributes:
        competition_status (Union[Unset, GetSeasonInfoResponse200SeasonInfoCompetitionStatus]):
    ...
    competition_status: Union[Unset, GetSeasonInfoResponse200SeasonInfoCompetitionStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competition_status, Unset):
            ...
            competition_status = GetSeasonInfoResponse200SeasonInfoCompetitionStatus(_competition_status)
        ...
        get_season_info_response_200_season_info = cls(
        ...
        return get_season_info_response_200_season_info
