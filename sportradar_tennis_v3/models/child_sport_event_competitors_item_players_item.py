...
from ..models.child_sport_event_competitors_item_players_item_gender import (
    ChildSportEventCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ChildSportEventCompetitorsItemPlayersItem")


@_attrs_define
class ChildSportEventCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, ChildSportEventCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, ChildSportEventCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = ChildSportEventCompetitorsItemPlayersItemGender(_gender)
        ...
        child_sport_event_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return child_sport_event_competitors_item_players_item
