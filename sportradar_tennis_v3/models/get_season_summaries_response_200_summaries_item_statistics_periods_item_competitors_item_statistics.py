...
T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemStatistics")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_season_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_statistics = cls(
            aces=aces,
        ...
        get_season_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_statistics.additional_properties = d
        return get_season_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_statistics
