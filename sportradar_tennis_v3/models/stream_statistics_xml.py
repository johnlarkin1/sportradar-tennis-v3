...
if TYPE_CHECKING:
    from ..models.stream_statistics_xml_metadata import StreamStatisticsXmlMetadata
...
class StreamStatisticsXml:
    """
    Attributes:
        metadata (Union[Unset, StreamStatisticsXmlMetadata]):
        payload (Union[Unset, StreamStatisticsXmlPayload]):
    """

    metadata: Union[Unset, "StreamStatisticsXmlMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = StreamStatisticsXmlMetadata.from_dict(_metadata)
