...
T = TypeVar("T", bound="GetRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor")


@_attrs_define
class GetRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_race_rankings_response_200_rankings_item_competitor_rankings_item_competitor = cls(
            id=id,
            name=name,
        ...
        get_race_rankings_response_200_rankings_item_competitor_rankings_item_competitor.additional_properties = d
        return get_race_rankings_response_200_rankings_item_competitor_rankings_item_competitor
