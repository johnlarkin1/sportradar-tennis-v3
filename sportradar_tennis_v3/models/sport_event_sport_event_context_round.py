...
from ..models.sport_event_sport_event_context_round_name import SportEventSportEventContextRoundName
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventSportEventContextRound")


@_attrs_define
class SportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, SportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, SportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = SportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        sport_event_sport_event_context_round = cls(
        ...
        return sport_event_sport_event_context_round
