...
T = TypeVar("T", bound="GetScheduleLiveSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemStatistics")


@_attrs_define
class GetScheduleLiveSummariesResponse200SummariesItemStatisticsPeriodsItemCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_schedule_live_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_statistics = (
            cls(
                aces=aces,
        ...
        get_schedule_live_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_statistics.additional_properties = d
        return (
            get_schedule_live_summaries_response_200_summaries_item_statistics_periods_item_competitors_item_statistics
        )
