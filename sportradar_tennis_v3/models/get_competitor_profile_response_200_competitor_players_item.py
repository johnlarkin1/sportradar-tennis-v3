...
from ..models.get_competitor_profile_response_200_competitor_players_item_gender import (
    GetCompetitorProfileResponse200CompetitorPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitorProfileResponse200CompetitorPlayersItem")


@_attrs_define
class GetCompetitorProfileResponse200CompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, GetCompetitorProfileResponse200CompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, GetCompetitorProfileResponse200CompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = GetCompetitorProfileResponse200CompetitorPlayersItemGender(_gender)
        ...
        get_competitor_profile_response_200_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return get_competitor_profile_response_200_competitor_players_item
