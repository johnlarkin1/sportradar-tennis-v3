...
from ..models.sport_event_coverage_sport_event_properties_scores import SportEventCoverageSportEventPropertiesScores
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventCoverageSportEventProperties")


@_attrs_define
class SportEventCoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, SportEventCoverageSportEventPropertiesScores]):
    """

    detailed_serve_outcomes: Union[Unset, bool] = UNSET
    enhanced_stats: Union[Unset, bool] = UNSET
    play_by_play: Union[Unset, bool] = UNSET
    scores: Union[Unset, SportEventCoverageSportEventPropertiesScores] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = SportEventCoverageSportEventPropertiesScores(_scores)

        sport_event_coverage_sport_event_properties = cls(
        ...
        sport_event_coverage_sport_event_properties.additional_properties = d
        return sport_event_coverage_sport_event_properties
