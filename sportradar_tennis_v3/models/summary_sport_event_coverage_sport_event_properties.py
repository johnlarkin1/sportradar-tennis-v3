...
from ..models.summary_sport_event_coverage_sport_event_properties_scores import (
    SummarySportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummarySportEventCoverageSportEventProperties")


@_attrs_define
class SummarySportEventCoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, SummarySportEventCoverageSportEventPropertiesScores]):
    """

    detailed_serve_outcomes: Union[Unset, bool] = UNSET
    enhanced_stats: Union[Unset, bool] = UNSET
    play_by_play: Union[Unset, bool] = UNSET
    scores: Union[Unset, SummarySportEventCoverageSportEventPropertiesScores] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = SummarySportEventCoverageSportEventPropertiesScores(_scores)

        summary_sport_event_coverage_sport_event_properties = cls(
        ...
        summary_sport_event_coverage_sport_event_properties.additional_properties = d
        return summary_sport_event_coverage_sport_event_properties
