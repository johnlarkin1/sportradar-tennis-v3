...
from ..models.game_state_advantage import GameStateAdvantage
from ..models.game_state_last_point_result import GameStateLastPointResult
from ..models.game_state_point_type import GameStatePointType
from ..models.game_state_serving import GameStateServing
...
class GameState:
    """
    Attributes:
        advantage (Union[Unset, GameStateAdvantage]):
        away_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        last_point_result (Union[Unset, GameStateLastPointResult]):
        point_type (Union[Unset, GameStatePointType]):
        serving (Union[Unset, GameStateServing]):
        tie_break (Union[Unset, bool]):
    """

    advantage: Union[Unset, GameStateAdvantage] = UNSET
    away_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    last_point_result: Union[Unset, GameStateLastPointResult] = UNSET
    point_type: Union[Unset, GameStatePointType] = UNSET
    serving: Union[Unset, GameStateServing] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_advantage, Unset):
            ...
            advantage = GameStateAdvantage(_advantage)
        ...
        if isinstance(_last_point_result, Unset):
            ...
            last_point_result = GameStateLastPointResult(_last_point_result)
        ...
        if isinstance(_point_type, Unset):
            ...
            point_type = GameStatePointType(_point_type)
        ...
        if isinstance(_serving, Unset):
            ...
            serving = GameStateServing(_serving)
