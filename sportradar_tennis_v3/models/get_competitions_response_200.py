...
if TYPE_CHECKING:
    from ..models.get_competitions_response_200_competitions_item import GetCompetitionsResponse200CompetitionsItem


T = TypeVar("T", bound="GetCompetitionsResponse200")


@_attrs_define
class GetCompetitionsResponse200:
    """
    Attributes:
        competitions (Union[Unset, List['GetCompetitionsResponse200CompetitionsItem']]):
        generated_at (Union[Unset, datetime.datetime]):
    """

    competitions: Union[Unset, List["GetCompetitionsResponse200CompetitionsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for competitions_item_data in _competitions or []:
            competitions_item = GetCompetitionsResponse200CompetitionsItem.from_dict(competitions_item_data)
        ...
        get_competitions_response_200 = cls(
            competitions=competitions,
            generated_at=generated_at,
        )

        return get_competitions_response_200
