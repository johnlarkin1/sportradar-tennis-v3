...
from ..models.sport_event_probability_sport_event_children_item_type import (
    SportEventProbabilitySportEventChildrenItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_probability_sport_event_children_item_competitors_item import (
        SportEventProbabilitySportEventChildrenItemCompetitorsItem,
    )
    from ..models.sport_event_probability_sport_event_children_item_venue import (
        SportEventProbabilitySportEventChildrenItemVenue,
    )


T = TypeVar("T", bound="SportEventProbabilitySportEventChildrenItem")


@_attrs_define
class SportEventProbabilitySportEventChildrenItem:
    """
    Attributes:
        id (str):
        start_time (datetime.datetime): Scheduled event start
        start_time_confirmed (bool):
        competitors (Union[Unset, List['SportEventProbabilitySportEventChildrenItemCompetitorsItem']]):
        ...
        type (Union[Unset, SportEventProbabilitySportEventChildrenItemType]):
        venue (Union[Unset, SportEventProbabilitySportEventChildrenItemVenue]):
    """

    id: str
    start_time: datetime.datetime
    start_time_confirmed: bool
    competitors: Union[Unset, List["SportEventProbabilitySportEventChildrenItemCompetitorsItem"]] = UNSET
    parent_id: Union[Unset, str] = UNSET
    replaced_by: Union[Unset, str] = UNSET
    resume_time: Union[Unset, datetime.datetime] = UNSET
    type: Union[Unset, SportEventProbabilitySportEventChildrenItemType] = UNSET
    venue: Union[Unset, "SportEventProbabilitySportEventChildrenItemVenue"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for competitors_item_data in _competitors or []:
            competitors_item = SportEventProbabilitySportEventChildrenItemCompetitorsItem.from_dict(
        ...
        if isinstance(_type, Unset):
            ...
            type = SportEventProbabilitySportEventChildrenItemType(_type)
        ...
        if isinstance(_venue, Unset):
            ...
            venue = SportEventProbabilitySportEventChildrenItemVenue.from_dict(_venue)

        sport_event_probability_sport_event_children_item = cls(
            id=id,
            start_time=start_time,
            start_time_confirmed=start_time_confirmed,
        ...
        return sport_event_probability_sport_event_children_item
