...
if TYPE_CHECKING:
    from ..models.probability_market_two_three_way_outcomes_item import ProbabilityMarketTwoThreeWayOutcomesItem
...
class ProbabilityMarketTwoThreeWay:
    ...
    Attributes:
        ...
        outcomes (List['ProbabilityMarketTwoThreeWayOutcomesItem']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for outcomes_item_data in _outcomes:
            outcomes_item = ProbabilityMarketTwoThreeWayOutcomesItem.from_dict(outcomes_item_data)
