...
T = TypeVar("T", bound="GetComplexesResponse200ComplexesItemVenuesItem")


@_attrs_define
class GetComplexesResponse200ComplexesItemVenuesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_complexes_response_200_complexes_item_venues_item = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return get_complexes_response_200_complexes_item_venues_item
