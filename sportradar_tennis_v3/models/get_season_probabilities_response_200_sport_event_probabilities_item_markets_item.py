...
from ..models.get_season_probabilities_response_200_sport_event_probabilities_item_markets_item_name import (
    GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItemName,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_season_probabilities_response_200_sport_event_probabilities_item_markets_item_outcomes_item import (
        GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItemOutcomesItem,
    )


T = TypeVar("T", bound="GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItem")


@_attrs_define
class GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItem:
    """
    Attributes:
        name (GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItemName):
        outcomes (List['GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItemOutcomesItem']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        name = GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItemName(d.pop("name"))

        outcomes = []
        _outcomes = d.pop("outcomes")
        for outcomes_item_data in _outcomes:
            outcomes_item = (
                GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemMarketsItemOutcomesItem.from_dict(
                    outcomes_item_data
                )
            )
        ...
        get_season_probabilities_response_200_sport_event_probabilities_item_markets_item = cls(
            name=name,
            outcomes=outcomes,
        ...
        return get_season_probabilities_response_200_sport_event_probabilities_item_markets_item
