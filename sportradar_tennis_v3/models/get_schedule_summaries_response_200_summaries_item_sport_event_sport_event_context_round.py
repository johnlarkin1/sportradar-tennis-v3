...
from ..models.get_schedule_summaries_response_200_summaries_item_sport_event_sport_event_context_round_name import (
    GetScheduleSummariesResponse200SummariesItemSportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetScheduleSummariesResponse200SummariesItemSportEventSportEventContextRound")


@_attrs_define
class GetScheduleSummariesResponse200SummariesItemSportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, GetScheduleSummariesResponse200SummariesItemSportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, GetScheduleSummariesResponse200SummariesItemSportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetScheduleSummariesResponse200SummariesItemSportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        get_schedule_summaries_response_200_summaries_item_sport_event_sport_event_context_round = cls(
        ...
        return get_schedule_summaries_response_200_summaries_item_sport_event_sport_event_context_round
