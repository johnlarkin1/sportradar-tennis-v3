...
from ..models.get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_coverage_sport_event_properties_scores import (
    GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventCoverageSportEventProperties")


@_attrs_define
class GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventCoverageSportEventProperties:
    """
    Attributes:
    ...
    scores: Union[
        Unset, GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventCoverageSportEventPropertiesScores
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_coverage_sport_event_properties = (
            cls(
        ...
        get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_coverage_sport_event_properties.additional_properties = d
        return (
            get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_coverage_sport_event_properties
        )
