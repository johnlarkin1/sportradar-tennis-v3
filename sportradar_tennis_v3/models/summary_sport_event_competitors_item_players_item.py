...
from ..models.summary_sport_event_competitors_item_players_item_gender import (
    SummarySportEventCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummarySportEventCompetitorsItemPlayersItem")


@_attrs_define
class SummarySportEventCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SummarySportEventCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SummarySportEventCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SummarySportEventCompetitorsItemPlayersItemGender(_gender)
        ...
        summary_sport_event_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return summary_sport_event_competitors_item_players_item
