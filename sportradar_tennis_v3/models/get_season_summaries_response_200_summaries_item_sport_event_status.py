...
from ..models.get_season_summaries_response_200_summaries_item_sport_event_status_match_status import (
    GetSeasonSummariesResponse200SummariesItemSportEventStatusMatchStatus,
)
from ..models.get_season_summaries_response_200_summaries_item_sport_event_status_status import (
    GetSeasonSummariesResponse200SummariesItemSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_season_summaries_response_200_summaries_item_sport_event_status_game_state import (
        GetSeasonSummariesResponse200SummariesItemSportEventStatusGameState,
    )
    from ..models.get_season_summaries_response_200_summaries_item_sport_event_status_period_scores_item import (
        GetSeasonSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemSportEventStatus")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemSportEventStatus:
    """
    Attributes:
        status (GetSeasonSummariesResponse200SummariesItemSportEventStatusStatus):
        ...
        game_state (Union[Unset, GetSeasonSummariesResponse200SummariesItemSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetSeasonSummariesResponse200SummariesItemSportEventStatusMatchStatus]):
        period_scores (Union[Unset,
            List['GetSeasonSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetSeasonSummariesResponse200SummariesItemSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, GetSeasonSummariesResponse200SummariesItemSportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["GetSeasonSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetSeasonSummariesResponse200SummariesItemSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetSeasonSummariesResponse200SummariesItemSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetSeasonSummariesResponse200SummariesItemSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = GetSeasonSummariesResponse200SummariesItemSportEventStatusPeriodScoresItem.from_dict(
        ...
        get_season_summaries_response_200_summaries_item_sport_event_status = cls(
            status=status,
        ...
        return get_season_summaries_response_200_summaries_item_sport_event_status
