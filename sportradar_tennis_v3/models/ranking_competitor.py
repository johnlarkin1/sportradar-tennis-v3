...
if TYPE_CHECKING:
    from ..models.ranking_competitor_competitor import RankingCompetitorCompetitor


T = TypeVar("T", bound="RankingCompetitor")


@_attrs_define
class RankingCompetitor:
    """
    Attributes:
        competitions_played (Union[Unset, int]):
        competitor (Union[Unset, RankingCompetitorCompetitor]):
    ...
    competitor: Union[Unset, "RankingCompetitorCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = RankingCompetitorCompetitor.from_dict(_competitor)
