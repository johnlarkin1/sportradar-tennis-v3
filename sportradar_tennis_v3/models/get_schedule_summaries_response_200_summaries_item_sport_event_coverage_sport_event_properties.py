...
from ..models.get_schedule_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties_scores import (
    GetScheduleSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetScheduleSummariesResponse200SummariesItemSportEventCoverageSportEventProperties")


@_attrs_define
class GetScheduleSummariesResponse200SummariesItemSportEventCoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, GetScheduleSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = GetScheduleSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores(_scores)

        get_schedule_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties = cls(
        ...
        get_schedule_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties.additional_properties = d
        return get_schedule_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties
