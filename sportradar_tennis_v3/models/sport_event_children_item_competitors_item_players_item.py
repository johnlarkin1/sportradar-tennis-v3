...
from ..models.sport_event_children_item_competitors_item_players_item_gender import (
    SportEventChildrenItemCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventChildrenItemCompetitorsItemPlayersItem")


@_attrs_define
class SportEventChildrenItemCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SportEventChildrenItemCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SportEventChildrenItemCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SportEventChildrenItemCompetitorsItemPlayersItemGender(_gender)
        ...
        sport_event_children_item_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return sport_event_children_item_competitors_item_players_item
