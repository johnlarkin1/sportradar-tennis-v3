...
from ..models.sport_event_timeline_sport_event_status_period_scores_item_type import (
    SportEventTimelineSportEventStatusPeriodScoresItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventTimelineSportEventStatusPeriodScoresItem")


@_attrs_define
class SportEventTimelineSportEventStatusPeriodScoresItem:
    """
    Attributes:
        away_score (int):
        home_score (int):
        ...
        type (Union[Unset, SportEventTimelineSportEventStatusPeriodScoresItemType]):
    """
    ...
    type: Union[Unset, SportEventTimelineSportEventStatusPeriodScoresItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = SportEventTimelineSportEventStatusPeriodScoresItemType(_type)

        sport_event_timeline_sport_event_status_period_scores_item = cls(
            away_score=away_score,
            home_score=home_score,
        ...
        return sport_event_timeline_sport_event_status_period_scores_item
