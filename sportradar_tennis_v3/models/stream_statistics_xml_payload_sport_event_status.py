...
from ..models.stream_statistics_xml_payload_sport_event_status_match_status import (
    StreamStatisticsXmlPayloadSportEventStatusMatchStatus,
)
from ..models.stream_statistics_xml_payload_sport_event_status_status import (
    StreamStatisticsXmlPayloadSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.stream_statistics_xml_payload_sport_event_status_game_state import (
        StreamStatisticsXmlPayloadSportEventStatusGameState,
    )
    from ..models.stream_statistics_xml_payload_sport_event_status_period_scores_item import (
        StreamStatisticsXmlPayloadSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="StreamStatisticsXmlPayloadSportEventStatus")


@_attrs_define
class StreamStatisticsXmlPayloadSportEventStatus:
    """
    Attributes:
        status (StreamStatisticsXmlPayloadSportEventStatusStatus):
        ...
        game_state (Union[Unset, StreamStatisticsXmlPayloadSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, StreamStatisticsXmlPayloadSportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['StreamStatisticsXmlPayloadSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "StreamStatisticsXmlPayloadSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, StreamStatisticsXmlPayloadSportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["StreamStatisticsXmlPayloadSportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = StreamStatisticsXmlPayloadSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = StreamStatisticsXmlPayloadSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = StreamStatisticsXmlPayloadSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = StreamStatisticsXmlPayloadSportEventStatusPeriodScoresItem.from_dict(
        ...
        stream_statistics_xml_payload_sport_event_status = cls(
            status=status,
        ...
        return stream_statistics_xml_payload_sport_event_status
