...
from ..models.summary_statistics_totals_competitors_item_players_item_gender import (
    SummaryStatisticsTotalsCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummaryStatisticsTotalsCompetitorsItemPlayersItem")


@_attrs_define
class SummaryStatisticsTotalsCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SummaryStatisticsTotalsCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SummaryStatisticsTotalsCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SummaryStatisticsTotalsCompetitorsItemPlayersItemGender(_gender)
        ...
        summary_statistics_totals_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return summary_statistics_totals_competitors_item_players_item
