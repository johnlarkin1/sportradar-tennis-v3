...
from ..models.summary_sport_event_children_item_competitors_item_players_item_gender import (
    SummarySportEventChildrenItemCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummarySportEventChildrenItemCompetitorsItemPlayersItem")


@_attrs_define
class SummarySportEventChildrenItemCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SummarySportEventChildrenItemCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SummarySportEventChildrenItemCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SummarySportEventChildrenItemCompetitorsItemPlayersItemGender(_gender)
        ...
        summary_sport_event_children_item_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return summary_sport_event_children_item_competitors_item_players_item
