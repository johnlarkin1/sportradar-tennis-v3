...
T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemSportEventChildrenItemVenue")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemSportEventChildrenItemVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_season_summaries_response_200_summaries_item_sport_event_children_item_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return get_season_summaries_response_200_summaries_item_sport_event_children_item_venue
