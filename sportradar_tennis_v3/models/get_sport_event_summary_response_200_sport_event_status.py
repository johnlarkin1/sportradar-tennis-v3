...
from ..models.get_sport_event_summary_response_200_sport_event_status_match_status import (
    GetSportEventSummaryResponse200SportEventStatusMatchStatus,
)
from ..models.get_sport_event_summary_response_200_sport_event_status_status import (
    GetSportEventSummaryResponse200SportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_sport_event_summary_response_200_sport_event_status_game_state import (
        GetSportEventSummaryResponse200SportEventStatusGameState,
    )
    from ..models.get_sport_event_summary_response_200_sport_event_status_period_scores_item import (
        GetSportEventSummaryResponse200SportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetSportEventSummaryResponse200SportEventStatus")


@_attrs_define
class GetSportEventSummaryResponse200SportEventStatus:
    """
    Attributes:
        status (GetSportEventSummaryResponse200SportEventStatusStatus):
        ...
        game_state (Union[Unset, GetSportEventSummaryResponse200SportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetSportEventSummaryResponse200SportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['GetSportEventSummaryResponse200SportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetSportEventSummaryResponse200SportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, GetSportEventSummaryResponse200SportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["GetSportEventSummaryResponse200SportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetSportEventSummaryResponse200SportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetSportEventSummaryResponse200SportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetSportEventSummaryResponse200SportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = GetSportEventSummaryResponse200SportEventStatusPeriodScoresItem.from_dict(
        ...
        get_sport_event_summary_response_200_sport_event_status = cls(
            status=status,
        ...
        return get_sport_event_summary_response_200_sport_event_status
