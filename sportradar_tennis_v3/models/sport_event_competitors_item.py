...
from ..models.sport_event_competitors_item_gender import SportEventCompetitorsItemGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_competitors_item_players_item import SportEventCompetitorsItemPlayersItem


T = TypeVar("T", bound="SportEventCompetitorsItem")


@_attrs_define
class SportEventCompetitorsItem:
    """
    Attributes:
        ...
        gender (Union[Unset, SportEventCompetitorsItemGender]):
        players (Union[Unset, List['SportEventCompetitorsItemPlayersItem']]):
    ...
    gender: Union[Unset, SportEventCompetitorsItemGender] = UNSET
    players: Union[Unset, List["SportEventCompetitorsItemPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SportEventCompetitorsItemGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = SportEventCompetitorsItemPlayersItem.from_dict(players_item_data)
        ...
        sport_event_competitors_item = cls(
            id=id,
            name=name,
        ...
        sport_event_competitors_item.additional_properties = d
        return sport_event_competitors_item
