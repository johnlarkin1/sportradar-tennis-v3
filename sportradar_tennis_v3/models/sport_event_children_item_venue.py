...
T = TypeVar("T", bound="SportEventChildrenItemVenue")


@_attrs_define
class SportEventChildrenItemVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sport_event_children_item_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return sport_event_children_item_venue
