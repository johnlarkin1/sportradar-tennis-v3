...
from ..models.base_summary_sport_event_competitors_item_gender import BaseSummarySportEventCompetitorsItemGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.base_summary_sport_event_competitors_item_players_item import (
        BaseSummarySportEventCompetitorsItemPlayersItem,
    )


T = TypeVar("T", bound="BaseSummarySportEventCompetitorsItem")


@_attrs_define
class BaseSummarySportEventCompetitorsItem:
    """
    Attributes:
        ...
        gender (Union[Unset, BaseSummarySportEventCompetitorsItemGender]):
        players (Union[Unset, List['BaseSummarySportEventCompetitorsItemPlayersItem']]):
    ...
    gender: Union[Unset, BaseSummarySportEventCompetitorsItemGender] = UNSET
    players: Union[Unset, List["BaseSummarySportEventCompetitorsItemPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = BaseSummarySportEventCompetitorsItemGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = BaseSummarySportEventCompetitorsItemPlayersItem.from_dict(players_item_data)
        ...
        base_summary_sport_event_competitors_item = cls(
            id=id,
            name=name,
        ...
        base_summary_sport_event_competitors_item.additional_properties = d
        return base_summary_sport_event_competitors_item
