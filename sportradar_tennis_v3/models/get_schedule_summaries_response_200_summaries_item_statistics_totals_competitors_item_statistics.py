...
T = TypeVar("T", bound="GetScheduleSummariesResponse200SummariesItemStatisticsTotalsCompetitorsItemStatistics")


@_attrs_define
class GetScheduleSummariesResponse200SummariesItemStatisticsTotalsCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_schedule_summaries_response_200_summaries_item_statistics_totals_competitors_item_statistics = cls(
            aces=aces,
        ...
        get_schedule_summaries_response_200_summaries_item_statistics_totals_competitors_item_statistics.additional_properties = d
        return get_schedule_summaries_response_200_summaries_item_statistics_totals_competitors_item_statistics
