...
from ..models.get_live_timelines_response_200_sport_event_timelines_item_sport_event_status_match_status import (
    GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusMatchStatus,
)
from ..models.get_live_timelines_response_200_sport_event_timelines_item_sport_event_status_status import (
    GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_live_timelines_response_200_sport_event_timelines_item_sport_event_status_game_state import (
        GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusGameState,
    )
    from ..models.get_live_timelines_response_200_sport_event_timelines_item_sport_event_status_period_scores_item import (
        GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatus")


@_attrs_define
class GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatus:
    """
    Attributes:
        status (GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusStatus):
        ...
        game_state (Union[Unset, GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusMatchStatus]):
        period_scores (Union[Unset,
            List['GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusMatchStatus] = UNSET
    period_scores: Union[
        Unset, List["GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusPeriodScoresItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusGameState.from_dict(
                _game_state
            )
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = (
                GetLiveTimelinesResponse200SportEventTimelinesItemSportEventStatusPeriodScoresItem.from_dict(
        ...
        get_live_timelines_response_200_sport_event_timelines_item_sport_event_status = cls(
            status=status,
        ...
        return get_live_timelines_response_200_sport_event_timelines_item_sport_event_status
