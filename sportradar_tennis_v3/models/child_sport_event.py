...
from ..models.child_sport_event_type import ChildSportEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.child_sport_event_competitors_item import ChildSportEventCompetitorsItem
    from ..models.child_sport_event_venue import ChildSportEventVenue


T = TypeVar("T", bound="ChildSportEvent")


@_attrs_define
class ChildSportEvent:
    """
    Attributes:
        id (str):
        start_time (datetime.datetime): Scheduled event start
        start_time_confirmed (bool):
        competitors (Union[Unset, List['ChildSportEventCompetitorsItem']]):
        ...
        type (Union[Unset, ChildSportEventType]):
        venue (Union[Unset, ChildSportEventVenue]):
    """

    id: str
    start_time: datetime.datetime
    start_time_confirmed: bool
    competitors: Union[Unset, List["ChildSportEventCompetitorsItem"]] = UNSET
    parent_id: Union[Unset, str] = UNSET
    replaced_by: Union[Unset, str] = UNSET
    resume_time: Union[Unset, datetime.datetime] = UNSET
    type: Union[Unset, ChildSportEventType] = UNSET
    venue: Union[Unset, "ChildSportEventVenue"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for competitors_item_data in _competitors or []:
            competitors_item = ChildSportEventCompetitorsItem.from_dict(competitors_item_data)
        ...
        if isinstance(_type, Unset):
            ...
            type = ChildSportEventType(_type)
        ...
        if isinstance(_venue, Unset):
            ...
            venue = ChildSportEventVenue.from_dict(_venue)

        child_sport_event = cls(
            id=id,
            start_time=start_time,
            start_time_confirmed=start_time_confirmed,
