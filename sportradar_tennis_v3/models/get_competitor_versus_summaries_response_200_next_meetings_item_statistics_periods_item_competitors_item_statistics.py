...
T = TypeVar(
    "T", bound="GetCompetitorVersusSummariesResponse200NextMeetingsItemStatisticsPeriodsItemCompetitorsItemStatistics"
)


@_attrs_define
class GetCompetitorVersusSummariesResponse200NextMeetingsItemStatisticsPeriodsItemCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_competitor_versus_summaries_response_200_next_meetings_item_statistics_periods_item_competitors_item_statistics = cls(
            aces=aces,
        ...
        get_competitor_versus_summaries_response_200_next_meetings_item_statistics_periods_item_competitors_item_statistics.additional_properties = d
        return get_competitor_versus_summaries_response_200_next_meetings_item_statistics_periods_item_competitors_item_statistics
