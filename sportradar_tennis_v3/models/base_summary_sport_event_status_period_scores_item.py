...
from ..models.base_summary_sport_event_status_period_scores_item_type import (
    BaseSummarySportEventStatusPeriodScoresItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseSummarySportEventStatusPeriodScoresItem")


@_attrs_define
class BaseSummarySportEventStatusPeriodScoresItem:
    """
    Attributes:
        away_score (int):
        home_score (int):
        ...
        type (Union[Unset, BaseSummarySportEventStatusPeriodScoresItemType]):
    """
    ...
    type: Union[Unset, BaseSummarySportEventStatusPeriodScoresItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = BaseSummarySportEventStatusPeriodScoresItemType(_type)

        base_summary_sport_event_status_period_scores_item = cls(
            away_score=away_score,
            home_score=home_score,
        ...
        return base_summary_sport_event_status_period_scores_item
