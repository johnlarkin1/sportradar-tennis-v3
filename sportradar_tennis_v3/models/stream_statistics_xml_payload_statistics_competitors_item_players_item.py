...
from ..models.stream_statistics_xml_payload_statistics_competitors_item_players_item_gender import (
    StreamStatisticsXmlPayloadStatisticsCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StreamStatisticsXmlPayloadStatisticsCompetitorsItemPlayersItem")


@_attrs_define
class StreamStatisticsXmlPayloadStatisticsCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, StreamStatisticsXmlPayloadStatisticsCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, StreamStatisticsXmlPayloadStatisticsCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = StreamStatisticsXmlPayloadStatisticsCompetitorsItemPlayersItemGender(_gender)
        ...
        stream_statistics_xml_payload_statistics_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return stream_statistics_xml_payload_statistics_competitors_item_players_item
