...
if TYPE_CHECKING:
    from ..models.get_race_rankings_response_200_rankings_item_competitor_rankings_item_competitor import (
        GetRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor,
    )


T = TypeVar("T", bound="GetRaceRankingsResponse200RankingsItemCompetitorRankingsItem")


@_attrs_define
class GetRaceRankingsResponse200RankingsItemCompetitorRankingsItem:
    """
    Attributes:
        competitions_played (Union[Unset, int]):
        competitor (Union[Unset, GetRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor]):
    ...
    competitor: Union[Unset, "GetRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = GetRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor.from_dict(_competitor)
        ...
        get_race_rankings_response_200_rankings_item_competitor_rankings_item = cls(
        ...
        return get_race_rankings_response_200_rankings_item_competitor_rankings_item
