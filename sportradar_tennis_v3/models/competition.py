...
from ..models.competition_level import CompetitionLevel
...
class Competition:
    ...
    Attributes:
        ...
        level (Union[Unset, CompetitionLevel]):
    ...
    level: Union[Unset, CompetitionLevel] = UNSET
