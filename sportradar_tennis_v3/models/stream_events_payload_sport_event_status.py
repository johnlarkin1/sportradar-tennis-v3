...
from ..models.stream_events_payload_sport_event_status_match_status import (
    StreamEventsPayloadSportEventStatusMatchStatus,
)
from ..models.stream_events_payload_sport_event_status_status import StreamEventsPayloadSportEventStatusStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.stream_events_payload_sport_event_status_game_state import (
        StreamEventsPayloadSportEventStatusGameState,
    )
    from ..models.stream_events_payload_sport_event_status_period_scores_item import (
        StreamEventsPayloadSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="StreamEventsPayloadSportEventStatus")


@_attrs_define
class StreamEventsPayloadSportEventStatus:
    """
    Attributes:
        status (StreamEventsPayloadSportEventStatusStatus):
        ...
        game_state (Union[Unset, StreamEventsPayloadSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, StreamEventsPayloadSportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['StreamEventsPayloadSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "StreamEventsPayloadSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, StreamEventsPayloadSportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["StreamEventsPayloadSportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = StreamEventsPayloadSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = StreamEventsPayloadSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = StreamEventsPayloadSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = StreamEventsPayloadSportEventStatusPeriodScoresItem.from_dict(period_scores_item_data)
        ...
        stream_events_payload_sport_event_status = cls(
            status=status,
        ...
        return stream_events_payload_sport_event_status
