...
if TYPE_CHECKING:
    from ..models.get_double_race_rankings_response_200_rankings_item_competitor_rankings_item_competitor import (
        GetDoubleRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor,
    )


T = TypeVar("T", bound="GetDoubleRaceRankingsResponse200RankingsItemCompetitorRankingsItem")


@_attrs_define
class GetDoubleRaceRankingsResponse200RankingsItemCompetitorRankingsItem:
    """
    Attributes:
        competitions_played (Union[Unset, int]):
        competitor (Union[Unset, GetDoubleRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor]):
    ...
    competitor: Union[Unset, "GetDoubleRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = GetDoubleRaceRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor.from_dict(
                _competitor
            )
        ...
        get_double_race_rankings_response_200_rankings_item_competitor_rankings_item = cls(
        ...
        return get_double_race_rankings_response_200_rankings_item_competitor_rankings_item
