...
if TYPE_CHECKING:
    from ..models.sport_event_coverage_sport_event_properties import SportEventCoverageSportEventProperties


T = TypeVar("T", bound="SportEventCoverage")


@_attrs_define
class SportEventCoverage:
    ...
    sport_event_properties. When type="competition" you will get sport_event_properties and competition_properties.
        ...
        Attributes:
            sport_event_properties (Union[Unset, SportEventCoverageSportEventProperties]):
            type (Union[Unset, str]):
    """

    sport_event_properties: Union[Unset, "SportEventCoverageSportEventProperties"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sport_event_properties, Unset):
            ...
            sport_event_properties = SportEventCoverageSportEventProperties.from_dict(_sport_event_properties)

        type = d.pop("type", UNSET)

        sport_event_coverage = cls(
            sport_event_properties=sport_event_properties,
            type=type,
        )

        return sport_event_coverage
