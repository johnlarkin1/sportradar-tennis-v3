...
from ..models.winner_last_season_competitor_players_item_gender import WinnerLastSeasonCompetitorPlayersItemGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="WinnerLastSeasonCompetitorPlayersItem")


@_attrs_define
class WinnerLastSeasonCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, WinnerLastSeasonCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, WinnerLastSeasonCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = WinnerLastSeasonCompetitorPlayersItemGender(_gender)
        ...
        winner_last_season_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return winner_last_season_competitor_players_item
