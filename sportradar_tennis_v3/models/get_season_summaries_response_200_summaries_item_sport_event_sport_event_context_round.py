...
from ..models.get_season_summaries_response_200_summaries_item_sport_event_sport_event_context_round_name import (
    GetSeasonSummariesResponse200SummariesItemSportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemSportEventSportEventContextRound")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemSportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, GetSeasonSummariesResponse200SummariesItemSportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, GetSeasonSummariesResponse200SummariesItemSportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetSeasonSummariesResponse200SummariesItemSportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        get_season_summaries_response_200_summaries_item_sport_event_sport_event_context_round = cls(
        ...
        return get_season_summaries_response_200_summaries_item_sport_event_sport_event_context_round
