...
from ..models.competitor_gender import CompetitorGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.competitor_players_item import CompetitorPlayersItem
...
class Competitor:
    ...
    Attributes:
        ...
        gender (Union[Unset, CompetitorGender]):
        players (Union[Unset, List['CompetitorPlayersItem']]):
    ...
    gender: Union[Unset, CompetitorGender] = UNSET
    players: Union[Unset, List["CompetitorPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = CompetitorGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = CompetitorPlayersItem.from_dict(players_item_data)
