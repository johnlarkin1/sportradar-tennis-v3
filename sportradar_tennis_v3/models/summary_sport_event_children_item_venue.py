...
T = TypeVar("T", bound="SummarySportEventChildrenItemVenue")


@_attrs_define
class SummarySportEventChildrenItemVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        summary_sport_event_children_item_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return summary_sport_event_children_item_venue
