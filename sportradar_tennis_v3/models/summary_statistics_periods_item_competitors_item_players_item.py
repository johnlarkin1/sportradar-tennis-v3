...
from ..models.summary_statistics_periods_item_competitors_item_players_item_gender import (
    SummaryStatisticsPeriodsItemCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummaryStatisticsPeriodsItemCompetitorsItemPlayersItem")


@_attrs_define
class SummaryStatisticsPeriodsItemCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SummaryStatisticsPeriodsItemCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SummaryStatisticsPeriodsItemCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SummaryStatisticsPeriodsItemCompetitorsItemPlayersItemGender(_gender)
        ...
        summary_statistics_periods_item_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return summary_statistics_periods_item_competitors_item_players_item
