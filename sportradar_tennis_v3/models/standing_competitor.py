...
if TYPE_CHECKING:
    from ..models.standing_competitor_comments_item import StandingCompetitorCommentsItem
    from ..models.standing_competitor_competitor import StandingCompetitorCompetitor


T = TypeVar("T", bound="StandingCompetitor")


@_attrs_define
class StandingCompetitor:
    """
    Attributes:
        comments (Union[Unset, List['StandingCompetitorCommentsItem']]):
        competitor (Union[Unset, StandingCompetitorCompetitor]):
    ...
    comments: Union[Unset, List["StandingCompetitorCommentsItem"]] = UNSET
    competitor: Union[Unset, "StandingCompetitorCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for comments_item_data in _comments or []:
            comments_item = StandingCompetitorCommentsItem.from_dict(comments_item_data)
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = StandingCompetitorCompetitor.from_dict(_competitor)
        ...
        standing_competitor.additional_properties = d
        return standing_competitor
