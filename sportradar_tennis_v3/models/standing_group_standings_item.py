...
if TYPE_CHECKING:
    from ..models.standing_group_standings_item_comments_item import StandingGroupStandingsItemCommentsItem
    from ..models.standing_group_standings_item_competitor import StandingGroupStandingsItemCompetitor


T = TypeVar("T", bound="StandingGroupStandingsItem")


@_attrs_define
class StandingGroupStandingsItem:
    """
    Attributes:
        comments (Union[Unset, List['StandingGroupStandingsItemCommentsItem']]):
        competitor (Union[Unset, StandingGroupStandingsItemCompetitor]):
    ...
    comments: Union[Unset, List["StandingGroupStandingsItemCommentsItem"]] = UNSET
    competitor: Union[Unset, "StandingGroupStandingsItemCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for comments_item_data in _comments or []:
            comments_item = StandingGroupStandingsItemCommentsItem.from_dict(comments_item_data)
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = StandingGroupStandingsItemCompetitor.from_dict(_competitor)
        ...
        standing_group_standings_item = cls(
            comments=comments,
        ...
        standing_group_standings_item.additional_properties = d
        return standing_group_standings_item
