...
from ..models.get_stream_statistics_response_200_type_0_payload_sport_event_status_match_status import (
    GetStreamStatisticsResponse200Type0PayloadSportEventStatusMatchStatus,
)
from ..models.get_stream_statistics_response_200_type_0_payload_sport_event_status_status import (
    GetStreamStatisticsResponse200Type0PayloadSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_stream_statistics_response_200_type_0_payload_sport_event_status_game_state import (
        GetStreamStatisticsResponse200Type0PayloadSportEventStatusGameState,
    )
    from ..models.get_stream_statistics_response_200_type_0_payload_sport_event_status_period_scores_item import (
        GetStreamStatisticsResponse200Type0PayloadSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetStreamStatisticsResponse200Type0PayloadSportEventStatus")


@_attrs_define
class GetStreamStatisticsResponse200Type0PayloadSportEventStatus:
    """
    Attributes:
        status (GetStreamStatisticsResponse200Type0PayloadSportEventStatusStatus):
        ...
        game_state (Union[Unset, GetStreamStatisticsResponse200Type0PayloadSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetStreamStatisticsResponse200Type0PayloadSportEventStatusMatchStatus]):
        period_scores (Union[Unset,
            List['GetStreamStatisticsResponse200Type0PayloadSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetStreamStatisticsResponse200Type0PayloadSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, GetStreamStatisticsResponse200Type0PayloadSportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["GetStreamStatisticsResponse200Type0PayloadSportEventStatusPeriodScoresItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetStreamStatisticsResponse200Type0PayloadSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetStreamStatisticsResponse200Type0PayloadSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetStreamStatisticsResponse200Type0PayloadSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = GetStreamStatisticsResponse200Type0PayloadSportEventStatusPeriodScoresItem.from_dict(
        ...
        get_stream_statistics_response_200_type_0_payload_sport_event_status = cls(
            status=status,
        ...
        return get_stream_statistics_response_200_type_0_payload_sport_event_status
