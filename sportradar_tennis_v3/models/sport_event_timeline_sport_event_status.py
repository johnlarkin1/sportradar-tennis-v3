...
from ..models.sport_event_timeline_sport_event_status_match_status import SportEventTimelineSportEventStatusMatchStatus
from ..models.sport_event_timeline_sport_event_status_status import SportEventTimelineSportEventStatusStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_timeline_sport_event_status_game_state import SportEventTimelineSportEventStatusGameState
    from ..models.sport_event_timeline_sport_event_status_period_scores_item import (
        SportEventTimelineSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="SportEventTimelineSportEventStatus")


@_attrs_define
class SportEventTimelineSportEventStatus:
    """
    Attributes:
        status (SportEventTimelineSportEventStatusStatus):
        ...
        game_state (Union[Unset, SportEventTimelineSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, SportEventTimelineSportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['SportEventTimelineSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "SportEventTimelineSportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, SportEventTimelineSportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["SportEventTimelineSportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.sport_event_timeline_sport_event_status_game_state import (
        ...
        d = src_dict.copy()
        status = SportEventTimelineSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = SportEventTimelineSportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = SportEventTimelineSportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = SportEventTimelineSportEventStatusPeriodScoresItem.from_dict(period_scores_item_data)
        ...
        sport_event_timeline_sport_event_status = cls(
            status=status,
        ...
        return sport_event_timeline_sport_event_status
