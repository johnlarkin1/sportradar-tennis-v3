...
from ..models.summary_sport_event_children_item_type import SummarySportEventChildrenItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.summary_sport_event_children_item_competitors_item import SummarySportEventChildrenItemCompetitorsItem
    from ..models.summary_sport_event_children_item_venue import SummarySportEventChildrenItemVenue


T = TypeVar("T", bound="SummarySportEventChildrenItem")


@_attrs_define
class SummarySportEventChildrenItem:
    """
    Attributes:
        id (str):
        start_time (datetime.datetime): Scheduled event start
        start_time_confirmed (bool):
        competitors (Union[Unset, List['SummarySportEventChildrenItemCompetitorsItem']]):
        ...
        type (Union[Unset, SummarySportEventChildrenItemType]):
        venue (Union[Unset, SummarySportEventChildrenItemVenue]):
    """

    id: str
    start_time: datetime.datetime
    start_time_confirmed: bool
    competitors: Union[Unset, List["SummarySportEventChildrenItemCompetitorsItem"]] = UNSET
    parent_id: Union[Unset, str] = UNSET
    replaced_by: Union[Unset, str] = UNSET
    resume_time: Union[Unset, datetime.datetime] = UNSET
    type: Union[Unset, SummarySportEventChildrenItemType] = UNSET
    venue: Union[Unset, "SummarySportEventChildrenItemVenue"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.summary_sport_event_children_item_competitors_item import (
        ...
        for competitors_item_data in _competitors or []:
            competitors_item = SummarySportEventChildrenItemCompetitorsItem.from_dict(competitors_item_data)
        ...
        if isinstance(_type, Unset):
            ...
            type = SummarySportEventChildrenItemType(_type)
        ...
        if isinstance(_venue, Unset):
            ...
            venue = SummarySportEventChildrenItemVenue.from_dict(_venue)

        summary_sport_event_children_item = cls(
            id=id,
            start_time=start_time,
            start_time_confirmed=start_time_confirmed,
        ...
        return summary_sport_event_children_item
