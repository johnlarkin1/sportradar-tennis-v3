...
if TYPE_CHECKING:
    from ..models.simple_season_stage_group_mappings_item import SimpleSeasonStageGroupMappingsItem
...
class SimpleSeasonStageGroup:
    ...
    Attributes:
        id (str):
        name (str):
        mappings (Union[Unset, List['SimpleSeasonStageGroupMappingsItem']]):
    """

    id: str
    name: str
    mappings: Union[Unset, List["SimpleSeasonStageGroupMappingsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for mappings_item_data in _mappings or []:
            mappings_item = SimpleSeasonStageGroupMappingsItem.from_dict(mappings_item_data)
