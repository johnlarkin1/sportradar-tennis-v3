...
if TYPE_CHECKING:
    from ..models.get_season_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties import (
        GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventProperties,
    )


T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemSportEventCoverage")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemSportEventCoverage:
    ...
    sport_event_properties: Union[
        Unset, "GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventProperties"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sport_event_properties, Unset):
            ...
            sport_event_properties = (
                GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventProperties.from_dict(
        ...
        get_season_summaries_response_200_summaries_item_sport_event_coverage = cls(
            sport_event_properties=sport_event_properties,
            type=type,
        )

        return get_season_summaries_response_200_summaries_item_sport_event_coverage
