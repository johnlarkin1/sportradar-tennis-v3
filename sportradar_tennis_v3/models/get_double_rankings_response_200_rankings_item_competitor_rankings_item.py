...
if TYPE_CHECKING:
    from ..models.get_double_rankings_response_200_rankings_item_competitor_rankings_item_competitor import (
        GetDoubleRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor,
    )


T = TypeVar("T", bound="GetDoubleRankingsResponse200RankingsItemCompetitorRankingsItem")


@_attrs_define
class GetDoubleRankingsResponse200RankingsItemCompetitorRankingsItem:
    """
    Attributes:
        competitions_played (Union[Unset, int]):
        competitor (Union[Unset, GetDoubleRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor]):
    ...
    competitor: Union[Unset, "GetDoubleRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = GetDoubleRankingsResponse200RankingsItemCompetitorRankingsItemCompetitor.from_dict(_competitor)
        ...
        get_double_rankings_response_200_rankings_item_competitor_rankings_item = cls(
        ...
        return get_double_rankings_response_200_rankings_item_competitor_rankings_item
