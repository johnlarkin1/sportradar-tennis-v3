...
from ..models.sport_event_type import SportEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sport_event_children_item import SportEventChildrenItem
    from ..models.sport_event_competitors_item import SportEventCompetitorsItem
    from ..models.sport_event_coverage import SportEventCoverage
    from ..models.sport_event_sport_event_context import SportEventSportEventContext
    from ..models.sport_event_venue import SportEventVenue


T = TypeVar("T", bound="SportEvent")
...
class SportEvent:
    ...
    Attributes:
        ...
        children (Union[Unset, List['SportEventChildrenItem']]):
        competitors (Union[Unset, List['SportEventCompetitorsItem']]):
        coverage (Union[Unset, SportEventCoverage]): Describes the expected coverage for different entities within this
            type. When type="sport_event" you will only get sport_event_properties. When type="competition" you will get
            sport_event_properties and competition_properties.
        ...
        sport_event_context (Union[Unset, SportEventSportEventContext]):
        type (Union[Unset, SportEventType]):
        venue (Union[Unset, SportEventVenue]):
    """

    id: str
    start_time: datetime.datetime
    start_time_confirmed: bool
    children: Union[Unset, List["SportEventChildrenItem"]] = UNSET
    competitors: Union[Unset, List["SportEventCompetitorsItem"]] = UNSET
    coverage: Union[Unset, "SportEventCoverage"] = UNSET
    estimated: Union[Unset, bool] = UNSET
    parent_id: Union[Unset, str] = UNSET
    replaced_by: Union[Unset, str] = UNSET
    resume_time: Union[Unset, datetime.datetime] = UNSET
    sport_event_context: Union[Unset, "SportEventSportEventContext"] = UNSET
    type: Union[Unset, SportEventType] = UNSET
    venue: Union[Unset, "SportEventVenue"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for children_item_data in _children or []:
            children_item = SportEventChildrenItem.from_dict(children_item_data)
        ...
        for competitors_item_data in _competitors or []:
            competitors_item = SportEventCompetitorsItem.from_dict(competitors_item_data)

            competitors.append(competitors_item)

        _coverage = d.pop("coverage", UNSET)
        coverage: Union[Unset, SportEventCoverage]
        if isinstance(_coverage, Unset):
            coverage = UNSET
        else:
            coverage = SportEventCoverage.from_dict(_coverage)
        ...
        if isinstance(_sport_event_context, Unset):
            ...
            sport_event_context = SportEventSportEventContext.from_dict(_sport_event_context)
        ...
        if isinstance(_venue, Unset):
            ...
            venue = SportEventVenue.from_dict(_venue)
