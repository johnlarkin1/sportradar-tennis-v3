...
from ..models.get_competition_info_response_200_info_competition_status import (
    GetCompetitionInfoResponse200InfoCompetitionStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitionInfoResponse200Info")


@_attrs_define
class GetCompetitionInfoResponse200Info:
    """
    Attributes:
        competition_status (Union[Unset, GetCompetitionInfoResponse200InfoCompetitionStatus]):
    ...
    competition_status: Union[Unset, GetCompetitionInfoResponse200InfoCompetitionStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competition_status, Unset):
            ...
            competition_status = GetCompetitionInfoResponse200InfoCompetitionStatus(_competition_status)
        ...
        get_competition_info_response_200_info = cls(
        ...
        return get_competition_info_response_200_info
