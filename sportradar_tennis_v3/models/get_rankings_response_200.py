...
if TYPE_CHECKING:
    from ..models.get_rankings_response_200_rankings_item import GetRankingsResponse200RankingsItem


T = TypeVar("T", bound="GetRankingsResponse200")


@_attrs_define
class GetRankingsResponse200:
    """
    Attributes:
        generated_at (Union[Unset, datetime.datetime]):
        rankings (Union[Unset, List['GetRankingsResponse200RankingsItem']]):
    """

    generated_at: Union[Unset, datetime.datetime] = UNSET
    rankings: Union[Unset, List["GetRankingsResponse200RankingsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for rankings_item_data in _rankings or []:
            rankings_item = GetRankingsResponse200RankingsItem.from_dict(rankings_item_data)

            rankings.append(rankings_item)

        get_rankings_response_200 = cls(
            generated_at=generated_at,
            rankings=rankings,
        )

        get_rankings_response_200.additional_properties = d
        return get_rankings_response_200
