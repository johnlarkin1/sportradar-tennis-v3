...
from ..models.ranking_competitor_competitor_players_item_gender import RankingCompetitorCompetitorPlayersItemGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="RankingCompetitorCompetitorPlayersItem")


@_attrs_define
class RankingCompetitorCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, RankingCompetitorCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, RankingCompetitorCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = RankingCompetitorCompetitorPlayersItemGender(_gender)
        ...
        ranking_competitor_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return ranking_competitor_competitor_players_item
