...
T = TypeVar("T", bound="SummaryStatisticsTotalsCompetitorsItemStatistics")


@_attrs_define
class SummaryStatisticsTotalsCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        summary_statistics_totals_competitors_item_statistics = cls(
            aces=aces,
        ...
        summary_statistics_totals_competitors_item_statistics.additional_properties = d
        return summary_statistics_totals_competitors_item_statistics
