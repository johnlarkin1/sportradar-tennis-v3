...
from ..models.season_stage_competitor_players_item_gender import SeasonStageCompetitorPlayersItemGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonStageCompetitorPlayersItem")


@_attrs_define
class SeasonStageCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SeasonStageCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, SeasonStageCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SeasonStageCompetitorPlayersItemGender(_gender)
        ...
        season_stage_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return season_stage_competitor_players_item
