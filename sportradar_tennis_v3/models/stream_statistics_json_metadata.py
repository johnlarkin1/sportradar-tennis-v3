...
T = TypeVar("T", bound="StreamStatisticsJsonMetadata")


@_attrs_define
class StreamStatisticsJsonMetadata:
    """
    Attributes:
        competition_id (str):
        event_id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stream_statistics_json_metadata = cls(
            competition_id=competition_id,
            event_id=event_id,
            format_=format_,
            season_id=season_id,
        ...
        stream_statistics_json_metadata.additional_properties = d
        return stream_statistics_json_metadata
