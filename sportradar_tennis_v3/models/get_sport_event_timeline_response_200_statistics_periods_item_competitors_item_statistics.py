...
T = TypeVar("T", bound="GetSportEventTimelineResponse200StatisticsPeriodsItemCompetitorsItemStatistics")


@_attrs_define
class GetSportEventTimelineResponse200StatisticsPeriodsItemCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_sport_event_timeline_response_200_statistics_periods_item_competitors_item_statistics = cls(
            aces=aces,
        ...
        get_sport_event_timeline_response_200_statistics_periods_item_competitors_item_statistics.additional_properties = d
        return get_sport_event_timeline_response_200_statistics_periods_item_competitors_item_statistics
