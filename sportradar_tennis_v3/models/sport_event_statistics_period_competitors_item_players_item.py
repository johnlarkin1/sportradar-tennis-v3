...
from ..models.sport_event_statistics_period_competitors_item_players_item_gender import (
    SportEventStatisticsPeriodCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventStatisticsPeriodCompetitorsItemPlayersItem")


@_attrs_define
class SportEventStatisticsPeriodCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SportEventStatisticsPeriodCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SportEventStatisticsPeriodCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SportEventStatisticsPeriodCompetitorsItemPlayersItemGender(_gender)
        ...
        sport_event_statistics_period_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return sport_event_statistics_period_competitors_item_players_item
