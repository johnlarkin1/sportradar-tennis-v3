...
from ..models.get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_status_match_status import (
    GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusMatchStatus,
)
from ..models.get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_status_status import (
    GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_status_game_state import (
        GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusGameState,
    )
    from ..models.get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_status_period_scores_item import (
        GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatus")


@_attrs_define
class GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatus:
    """
    Attributes:
        status (GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusStatus):
        ...
        game_state (Union[Unset, GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusMatchStatus]):
        period_scores (Union[Unset,
            List['GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusGameState"] = UNSET
    ...
    period_scores: Union[
        Unset, List["GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusPeriodScoresItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusGameState.from_dict(
                _game_state
            )
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusMatchStatus(
                _match_status
            )
        ...
        for period_scores_item_data in _period_scores or []:
            period_scores_item = (
                GetCompetitorVersusSummariesResponse200LastMeetingsItemSportEventStatusPeriodScoresItem.from_dict(
        ...
        get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_status = cls(
            status=status,
        ...
        return get_competitor_versus_summaries_response_200_last_meetings_item_sport_event_status
