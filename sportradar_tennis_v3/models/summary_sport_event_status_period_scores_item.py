...
from ..models.summary_sport_event_status_period_scores_item_type import SummarySportEventStatusPeriodScoresItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummarySportEventStatusPeriodScoresItem")


@_attrs_define
class SummarySportEventStatusPeriodScoresItem:
    """
    Attributes:
        away_score (int):
        home_score (int):
        ...
        type (Union[Unset, SummarySportEventStatusPeriodScoresItemType]):
    """
    ...
    type: Union[Unset, SummarySportEventStatusPeriodScoresItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = SummarySportEventStatusPeriodScoresItemType(_type)

        summary_sport_event_status_period_scores_item = cls(
            away_score=away_score,
            home_score=home_score,
        ...
        return summary_sport_event_status_period_scores_item
