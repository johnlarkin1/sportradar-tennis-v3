...
from ..models.get_competitor_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties_scores import (
    GetCompetitorSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitorSummariesResponse200SummariesItemSportEventCoverageSportEventProperties")


@_attrs_define
class GetCompetitorSummariesResponse200SummariesItemSportEventCoverageSportEventProperties:
    """
    Attributes:
    ...
    scores: Union[Unset, GetCompetitorSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores] = (
        UNSET
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = GetCompetitorSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores(_scores)

        get_competitor_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties = cls(
        ...
        get_competitor_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties.additional_properties = d
        return get_competitor_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties
