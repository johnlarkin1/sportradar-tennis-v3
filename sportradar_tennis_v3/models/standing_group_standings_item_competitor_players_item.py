...
from ..models.standing_group_standings_item_competitor_players_item_gender import (
    StandingGroupStandingsItemCompetitorPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StandingGroupStandingsItemCompetitorPlayersItem")


@_attrs_define
class StandingGroupStandingsItemCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, StandingGroupStandingsItemCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, StandingGroupStandingsItemCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = StandingGroupStandingsItemCompetitorPlayersItemGender(_gender)
        ...
        standing_group_standings_item_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return standing_group_standings_item_competitor_players_item
