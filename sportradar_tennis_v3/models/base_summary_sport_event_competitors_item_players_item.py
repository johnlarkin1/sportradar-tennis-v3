...
from ..models.base_summary_sport_event_competitors_item_players_item_gender import (
    BaseSummarySportEventCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseSummarySportEventCompetitorsItemPlayersItem")


@_attrs_define
class BaseSummarySportEventCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, BaseSummarySportEventCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, BaseSummarySportEventCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = BaseSummarySportEventCompetitorsItemPlayersItemGender(_gender)
        ...
        base_summary_sport_event_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return base_summary_sport_event_competitors_item_players_item
