...
T = TypeVar("T", bound="GetCompetitorProfileResponse200PeriodsItemStatistics")


@_attrs_define
class GetCompetitorProfileResponse200PeriodsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_competitor_profile_response_200_periods_item_statistics = cls(
        ...
        return get_competitor_profile_response_200_periods_item_statistics
