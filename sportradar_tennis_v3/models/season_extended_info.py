...
from ..models.season_extended_info_competition_status import SeasonExtendedInfoCompetitionStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonExtendedInfo")


@_attrs_define
class SeasonExtendedInfo:
    """
    Attributes:
        competition_status (Union[Unset, SeasonExtendedInfoCompetitionStatus]):
    ...
    competition_status: Union[Unset, SeasonExtendedInfoCompetitionStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competition_status, Unset):
            ...
            competition_status = SeasonExtendedInfoCompetitionStatus(_competition_status)
