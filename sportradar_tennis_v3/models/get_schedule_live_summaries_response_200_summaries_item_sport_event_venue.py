...
T = TypeVar("T", bound="GetScheduleLiveSummariesResponse200SummariesItemSportEventVenue")


@_attrs_define
class GetScheduleLiveSummariesResponse200SummariesItemSportEventVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_schedule_live_summaries_response_200_summaries_item_sport_event_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return get_schedule_live_summaries_response_200_summaries_item_sport_event_venue
