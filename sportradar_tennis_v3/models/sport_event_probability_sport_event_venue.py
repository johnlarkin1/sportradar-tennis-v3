...
T = TypeVar("T", bound="SportEventProbabilitySportEventVenue")


@_attrs_define
class SportEventProbabilitySportEventVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sport_event_probability_sport_event_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return sport_event_probability_sport_event_venue
