...
if TYPE_CHECKING:
    from ..models.season_brackets_group_cup_rounds_item_linked_cup_rounds_item import (
        SeasonBracketsGroupCupRoundsItemLinkedCupRoundsItem,
    )
    from ..models.season_brackets_group_cup_rounds_item_sport_events_item import (
        SeasonBracketsGroupCupRoundsItemSportEventsItem,
    )


T = TypeVar("T", bound="SeasonBracketsGroupCupRoundsItem")


@_attrs_define
class SeasonBracketsGroupCupRoundsItem:
    """
    Attributes:
        id (str): Cup round id URN (sr:cup_round:x)
        linked_cup_rounds (Union[Unset, List['SeasonBracketsGroupCupRoundsItemLinkedCupRoundsItem']]):
        name (Union[Unset, str]): Name of round. Ex. quarterfinal
        order (Union[Unset, int]):
        sport_events (Union[Unset, List['SeasonBracketsGroupCupRoundsItemSportEventsItem']]):
    ...
    id: str
    linked_cup_rounds: Union[Unset, List["SeasonBracketsGroupCupRoundsItemLinkedCupRoundsItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    order: Union[Unset, int] = UNSET
    sport_events: Union[Unset, List["SeasonBracketsGroupCupRoundsItemSportEventsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for linked_cup_rounds_item_data in _linked_cup_rounds or []:
            linked_cup_rounds_item = SeasonBracketsGroupCupRoundsItemLinkedCupRoundsItem.from_dict(
        ...
        for sport_events_item_data in _sport_events or []:
            sport_events_item = SeasonBracketsGroupCupRoundsItemSportEventsItem.from_dict(sport_events_item_data)
        ...
        season_brackets_group_cup_rounds_item = cls(
            id=id,
        ...
        season_brackets_group_cup_rounds_item.additional_properties = d
        return season_brackets_group_cup_rounds_item
