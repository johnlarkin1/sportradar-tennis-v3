...
T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemStatisticsTotalsCompetitorsItemStatistics")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemStatisticsTotalsCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_season_summaries_response_200_summaries_item_statistics_totals_competitors_item_statistics = cls(
            aces=aces,
        ...
        get_season_summaries_response_200_summaries_item_statistics_totals_competitors_item_statistics.additional_properties = d
        return get_season_summaries_response_200_summaries_item_statistics_totals_competitors_item_statistics
