...
from ..models.get_sport_event_timeline_response_200_sport_event_coverage_sport_event_properties_scores import (
    GetSportEventTimelineResponse200SportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSportEventTimelineResponse200SportEventCoverageSportEventProperties")


@_attrs_define
class GetSportEventTimelineResponse200SportEventCoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, GetSportEventTimelineResponse200SportEventCoverageSportEventPropertiesScores]):
    """

    detailed_serve_outcomes: Union[Unset, bool] = UNSET
    enhanced_stats: Union[Unset, bool] = UNSET
    play_by_play: Union[Unset, bool] = UNSET
    scores: Union[Unset, GetSportEventTimelineResponse200SportEventCoverageSportEventPropertiesScores] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = GetSportEventTimelineResponse200SportEventCoverageSportEventPropertiesScores(_scores)

        get_sport_event_timeline_response_200_sport_event_coverage_sport_event_properties = cls(
        ...
        get_sport_event_timeline_response_200_sport_event_coverage_sport_event_properties.additional_properties = d
        return get_sport_event_timeline_response_200_sport_event_coverage_sport_event_properties
