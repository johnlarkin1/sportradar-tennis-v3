...
from ..models.get_competitor_summaries_response_200_summaries_item_sport_event_sport_event_context_round_name import (
    GetCompetitorSummariesResponse200SummariesItemSportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitorSummariesResponse200SummariesItemSportEventSportEventContextRound")


@_attrs_define
class GetCompetitorSummariesResponse200SummariesItemSportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, GetCompetitorSummariesResponse200SummariesItemSportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, GetCompetitorSummariesResponse200SummariesItemSportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetCompetitorSummariesResponse200SummariesItemSportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        get_competitor_summaries_response_200_summaries_item_sport_event_sport_event_context_round = cls(
        ...
        return get_competitor_summaries_response_200_summaries_item_sport_event_sport_event_context_round
