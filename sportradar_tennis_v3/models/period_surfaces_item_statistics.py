...
T = TypeVar("T", bound="PeriodSurfacesItemStatistics")


@_attrs_define
class PeriodSurfacesItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        period_surfaces_item_statistics = cls(
        ...
        return period_surfaces_item_statistics
