...
from ..models.competition_with_competitors_competitors_item_gender import (
    CompetitionWithCompetitorsCompetitorsItemGender,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.competition_with_competitors_competitors_item_players_item import (
        CompetitionWithCompetitorsCompetitorsItemPlayersItem,
    )


T = TypeVar("T", bound="CompetitionWithCompetitorsCompetitorsItem")


@_attrs_define
class CompetitionWithCompetitorsCompetitorsItem:
    """
    Attributes:
        ...
        gender (Union[Unset, CompetitionWithCompetitorsCompetitorsItemGender]):
        players (Union[Unset, List['CompetitionWithCompetitorsCompetitorsItemPlayersItem']]):
    ...
    gender: Union[Unset, CompetitionWithCompetitorsCompetitorsItemGender] = UNSET
    players: Union[Unset, List["CompetitionWithCompetitorsCompetitorsItemPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = CompetitionWithCompetitorsCompetitorsItemGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = CompetitionWithCompetitorsCompetitorsItemPlayersItem.from_dict(players_item_data)
        ...
        competition_with_competitors_competitors_item = cls(
            id=id,
            name=name,
        ...
        competition_with_competitors_competitors_item.additional_properties = d
        return competition_with_competitors_competitors_item
