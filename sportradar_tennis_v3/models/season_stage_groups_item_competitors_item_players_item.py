...
from ..models.season_stage_groups_item_competitors_item_players_item_gender import (
    SeasonStageGroupsItemCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonStageGroupsItemCompetitorsItemPlayersItem")


@_attrs_define
class SeasonStageGroupsItemCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SeasonStageGroupsItemCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SeasonStageGroupsItemCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SeasonStageGroupsItemCompetitorsItemPlayersItemGender(_gender)
        ...
        season_stage_groups_item_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return season_stage_groups_item_competitors_item_players_item
