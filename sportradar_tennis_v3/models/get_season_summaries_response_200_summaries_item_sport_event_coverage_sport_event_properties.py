...
from ..models.get_season_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties_scores import (
    GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventProperties")


@_attrs_define
class GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores]):
    """

    detailed_serve_outcomes: Union[Unset, bool] = UNSET
    enhanced_stats: Union[Unset, bool] = UNSET
    play_by_play: Union[Unset, bool] = UNSET
    scores: Union[Unset, GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = GetSeasonSummariesResponse200SummariesItemSportEventCoverageSportEventPropertiesScores(_scores)

        get_season_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties = cls(
        ...
        get_season_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties.additional_properties = d
        return get_season_summaries_response_200_summaries_item_sport_event_coverage_sport_event_properties
