...
from ..models.get_sport_event_timeline_response_200_sport_event_status_match_status import (
    GetSportEventTimelineResponse200SportEventStatusMatchStatus,
)
from ..models.get_sport_event_timeline_response_200_sport_event_status_status import (
    GetSportEventTimelineResponse200SportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_sport_event_timeline_response_200_sport_event_status_game_state import (
        GetSportEventTimelineResponse200SportEventStatusGameState,
    )
    from ..models.get_sport_event_timeline_response_200_sport_event_status_period_scores_item import (
        GetSportEventTimelineResponse200SportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetSportEventTimelineResponse200SportEventStatus")


@_attrs_define
class GetSportEventTimelineResponse200SportEventStatus:
    """
    Attributes:
        status (GetSportEventTimelineResponse200SportEventStatusStatus):
        ...
        game_state (Union[Unset, GetSportEventTimelineResponse200SportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetSportEventTimelineResponse200SportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['GetSportEventTimelineResponse200SportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetSportEventTimelineResponse200SportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, GetSportEventTimelineResponse200SportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["GetSportEventTimelineResponse200SportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetSportEventTimelineResponse200SportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetSportEventTimelineResponse200SportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetSportEventTimelineResponse200SportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = GetSportEventTimelineResponse200SportEventStatusPeriodScoresItem.from_dict(
        ...
        get_sport_event_timeline_response_200_sport_event_status = cls(
            status=status,
        ...
        return get_sport_event_timeline_response_200_sport_event_status
