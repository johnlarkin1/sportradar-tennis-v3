...
from ..models.sport_event_competitors_item_players_item_gender import SportEventCompetitorsItemPlayersItemGender
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventCompetitorsItemPlayersItem")


@_attrs_define
class SportEventCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SportEventCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SportEventCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SportEventCompetitorsItemPlayersItemGender(_gender)
        ...
        sport_event_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return sport_event_competitors_item_players_item
