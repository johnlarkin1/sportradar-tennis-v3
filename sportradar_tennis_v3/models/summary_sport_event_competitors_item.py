...
from ..models.summary_sport_event_competitors_item_gender import SummarySportEventCompetitorsItemGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.summary_sport_event_competitors_item_players_item import SummarySportEventCompetitorsItemPlayersItem


T = TypeVar("T", bound="SummarySportEventCompetitorsItem")


@_attrs_define
class SummarySportEventCompetitorsItem:
    """
    Attributes:
        ...
        gender (Union[Unset, SummarySportEventCompetitorsItemGender]):
        players (Union[Unset, List['SummarySportEventCompetitorsItemPlayersItem']]):
    ...
    gender: Union[Unset, SummarySportEventCompetitorsItemGender] = UNSET
    players: Union[Unset, List["SummarySportEventCompetitorsItemPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.summary_sport_event_competitors_item_players_item import (
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SummarySportEventCompetitorsItemGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = SummarySportEventCompetitorsItemPlayersItem.from_dict(players_item_data)
        ...
        summary_sport_event_competitors_item = cls(
            id=id,
            name=name,
        ...
        summary_sport_event_competitors_item.additional_properties = d
        return summary_sport_event_competitors_item
