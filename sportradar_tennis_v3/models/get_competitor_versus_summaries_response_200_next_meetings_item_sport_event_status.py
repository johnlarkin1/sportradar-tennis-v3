...
from ..models.get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_status_match_status import (
    GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusMatchStatus,
)
from ..models.get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_status_status import (
    GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_status_game_state import (
        GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusGameState,
    )
    from ..models.get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_status_period_scores_item import (
        GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatus")


@_attrs_define
class GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatus:
    """
    Attributes:
        status (GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusStatus):
        ...
        game_state (Union[Unset, GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusMatchStatus]):
        period_scores (Union[Unset,
            List['GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusGameState"] = UNSET
    ...
    period_scores: Union[
        Unset, List["GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusPeriodScoresItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusGameState.from_dict(
                _game_state
            )
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusMatchStatus(
                _match_status
            )
        ...
        for period_scores_item_data in _period_scores or []:
            period_scores_item = (
                GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventStatusPeriodScoresItem.from_dict(
        ...
        get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_status = cls(
            status=status,
        ...
        return get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_status
