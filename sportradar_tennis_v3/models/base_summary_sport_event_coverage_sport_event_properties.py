...
from ..models.base_summary_sport_event_coverage_sport_event_properties_scores import (
    BaseSummarySportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseSummarySportEventCoverageSportEventProperties")


@_attrs_define
class BaseSummarySportEventCoverageSportEventProperties:
    """
    Attributes:
        ...
        scores (Union[Unset, BaseSummarySportEventCoverageSportEventPropertiesScores]):
    """

    detailed_serve_outcomes: Union[Unset, bool] = UNSET
    enhanced_stats: Union[Unset, bool] = UNSET
    play_by_play: Union[Unset, bool] = UNSET
    scores: Union[Unset, BaseSummarySportEventCoverageSportEventPropertiesScores] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = BaseSummarySportEventCoverageSportEventPropertiesScores(_scores)

        base_summary_sport_event_coverage_sport_event_properties = cls(
        ...
        base_summary_sport_event_coverage_sport_event_properties.additional_properties = d
        return base_summary_sport_event_coverage_sport_event_properties
