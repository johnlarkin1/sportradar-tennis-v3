...
T = TypeVar("T", bound="GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventVenue")


@_attrs_define
class GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_venue
