...
T = TypeVar("T", bound="BaseSummarySportEventChildrenItemVenue")


@_attrs_define
class BaseSummarySportEventChildrenItemVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        base_summary_sport_event_children_item_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return base_summary_sport_event_children_item_venue
