...
if TYPE_CHECKING:
    from ..models.season_stage_group_competitors_item import SeasonStageGroupCompetitorsItem
...
class SeasonStageGroup:
    ...
    Attributes:
        id (str):
        name (str):
        competitors (Union[Unset, List['SeasonStageGroupCompetitorsItem']]):
    ...
    id: str
    name: str
    competitors: Union[Unset, List["SeasonStageGroupCompetitorsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for competitors_item_data in _competitors or []:
            competitors_item = SeasonStageGroupCompetitorsItem.from_dict(competitors_item_data)
