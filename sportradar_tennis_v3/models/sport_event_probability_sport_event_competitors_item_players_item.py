...
from ..models.sport_event_probability_sport_event_competitors_item_players_item_gender import (
    SportEventProbabilitySportEventCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventProbabilitySportEventCompetitorsItemPlayersItem")


@_attrs_define
class SportEventProbabilitySportEventCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SportEventProbabilitySportEventCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SportEventProbabilitySportEventCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SportEventProbabilitySportEventCompetitorsItemPlayersItemGender(_gender)
        ...
        sport_event_probability_sport_event_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return sport_event_probability_sport_event_competitors_item_players_item
