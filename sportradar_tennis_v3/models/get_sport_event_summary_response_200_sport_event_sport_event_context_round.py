...
from ..models.get_sport_event_summary_response_200_sport_event_sport_event_context_round_name import (
    GetSportEventSummaryResponse200SportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSportEventSummaryResponse200SportEventSportEventContextRound")


@_attrs_define
class GetSportEventSummaryResponse200SportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, GetSportEventSummaryResponse200SportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, GetSportEventSummaryResponse200SportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetSportEventSummaryResponse200SportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        get_sport_event_summary_response_200_sport_event_sport_event_context_round = cls(
        ...
        return get_sport_event_summary_response_200_sport_event_sport_event_context_round
