...
from ..models.get_live_timelines_delta_response_200_sport_event_timeline_deltas_item_sport_event_timeline_sport_event_status_match_status import (
    GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusMatchStatus,
)
from ..models.get_live_timelines_delta_response_200_sport_event_timeline_deltas_item_sport_event_timeline_sport_event_status_status import (
    GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_live_timelines_delta_response_200_sport_event_timeline_deltas_item_sport_event_timeline_sport_event_status_game_state import (
        GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusGameState,
    )
    from ..models.get_live_timelines_delta_response_200_sport_event_timeline_deltas_item_sport_event_timeline_sport_event_status_period_scores_item import (
        GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusPeriodScoresItem,
    )


T = TypeVar("T", bound="GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatus")


@_attrs_define
class GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatus:
    """
    Attributes:
        status (GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusStatus):
        ...
        match_status (Union[Unset,
            GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimeline
    ...
    game_state: Union[
        Unset, "GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusGameState"
    ] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[
        Unset, GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusMatchStatus
    ] = UNSET
    period_scores: Union[
        Unset,
        List[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusGameState.from_dict(
                _game_state
            )
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusMatchStatus(
                _match_status
            )
        ...
        for period_scores_item_data in _period_scores or []:
            period_scores_item = GetLiveTimelinesDeltaResponse200SportEventTimelineDeltasItemSportEventTimelineSportEventStatusPeriodScoresItem.from_dict(
        ...
        get_live_timelines_delta_response_200_sport_event_timeline_deltas_item_sport_event_timeline_sport_event_status = cls(
            status=status,
        ...
        return get_live_timelines_delta_response_200_sport_event_timeline_deltas_item_sport_event_timeline_sport_event_status
