...
from ..models.get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_coverage_sport_event_properties_scores import (
    GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventCoverageSportEventPropertiesScores,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventCoverageSportEventProperties")


@_attrs_define
class GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventCoverageSportEventProperties:
    """
    Attributes:
    ...
    scores: Union[
        Unset, GetCompetitorVersusSummariesResponse200NextMeetingsItemSportEventCoverageSportEventPropertiesScores
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_coverage_sport_event_properties = (
            cls(
        ...
        get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_coverage_sport_event_properties.additional_properties = d
        return (
            get_competitor_versus_summaries_response_200_next_meetings_item_sport_event_coverage_sport_event_properties
        )
