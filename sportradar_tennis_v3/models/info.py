...
from ..models.info_competition_status import InfoCompetitionStatus
...
class Info:
    """
    Attributes:
        competition_status (Union[Unset, InfoCompetitionStatus]):
    ...
    competition_status: Union[Unset, InfoCompetitionStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competition_status, Unset):
            ...
            competition_status = InfoCompetitionStatus(_competition_status)
