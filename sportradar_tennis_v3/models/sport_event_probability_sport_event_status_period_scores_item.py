...
from ..models.sport_event_probability_sport_event_status_period_scores_item_type import (
    SportEventProbabilitySportEventStatusPeriodScoresItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventProbabilitySportEventStatusPeriodScoresItem")


@_attrs_define
class SportEventProbabilitySportEventStatusPeriodScoresItem:
    """
    Attributes:
        away_score (int):
        home_score (int):
        ...
        type (Union[Unset, SportEventProbabilitySportEventStatusPeriodScoresItemType]):
    """
    ...
    type: Union[Unset, SportEventProbabilitySportEventStatusPeriodScoresItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = SportEventProbabilitySportEventStatusPeriodScoresItemType(_type)

        sport_event_probability_sport_event_status_period_scores_item = cls(
            away_score=away_score,
            home_score=home_score,
        ...
        return sport_event_probability_sport_event_status_period_scores_item
