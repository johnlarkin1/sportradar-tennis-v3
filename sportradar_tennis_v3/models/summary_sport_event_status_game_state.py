...
from ..models.summary_sport_event_status_game_state_advantage import SummarySportEventStatusGameStateAdvantage
from ..models.summary_sport_event_status_game_state_last_point_result import (
    SummarySportEventStatusGameStateLastPointResult,
)
from ..models.summary_sport_event_status_game_state_point_type import SummarySportEventStatusGameStatePointType
from ..models.summary_sport_event_status_game_state_serving import SummarySportEventStatusGameStateServing
from ..types import UNSET, Unset

T = TypeVar("T", bound="SummarySportEventStatusGameState")


@_attrs_define
class SummarySportEventStatusGameState:
    """
    Attributes:
        advantage (Union[Unset, SummarySportEventStatusGameStateAdvantage]):
        away_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        last_point_result (Union[Unset, SummarySportEventStatusGameStateLastPointResult]):
        point_type (Union[Unset, SummarySportEventStatusGameStatePointType]):
        serving (Union[Unset, SummarySportEventStatusGameStateServing]):
        tie_break (Union[Unset, bool]):
    """

    advantage: Union[Unset, SummarySportEventStatusGameStateAdvantage] = UNSET
    away_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    last_point_result: Union[Unset, SummarySportEventStatusGameStateLastPointResult] = UNSET
    point_type: Union[Unset, SummarySportEventStatusGameStatePointType] = UNSET
    serving: Union[Unset, SummarySportEventStatusGameStateServing] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_advantage, Unset):
            ...
            advantage = SummarySportEventStatusGameStateAdvantage(_advantage)
        ...
        if isinstance(_last_point_result, Unset):
            ...
            last_point_result = SummarySportEventStatusGameStateLastPointResult(_last_point_result)
        ...
        if isinstance(_point_type, Unset):
            ...
            point_type = SummarySportEventStatusGameStatePointType(_point_type)
        ...
        if isinstance(_serving, Unset):
            ...
            serving = SummarySportEventStatusGameStateServing(_serving)

        tie_break = d.pop("tie_break", UNSET)

        summary_sport_event_status_game_state = cls(
            advantage=advantage,
        ...
        return summary_sport_event_status_game_state
