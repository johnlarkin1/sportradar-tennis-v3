...
T = TypeVar("T", bound="GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventVenue")


@_attrs_define
class GetSeasonProbabilitiesResponse200SportEventProbabilitiesItemSportEventVenue:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_venue = cls(
            id=id,
            name=name,
            capacity=capacity,
            changed=changed,
        ...
        return get_season_probabilities_response_200_sport_event_probabilities_item_sport_event_venue
