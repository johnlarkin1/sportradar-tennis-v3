...
from ..models.get_season_info_response_200_winner_last_season_competitor_players_item_gender import (
    GetSeasonInfoResponse200WinnerLastSeasonCompetitorPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSeasonInfoResponse200WinnerLastSeasonCompetitorPlayersItem")


@_attrs_define
class GetSeasonInfoResponse200WinnerLastSeasonCompetitorPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, GetSeasonInfoResponse200WinnerLastSeasonCompetitorPlayersItemGender]):
    ...
    gender: Union[Unset, GetSeasonInfoResponse200WinnerLastSeasonCompetitorPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = GetSeasonInfoResponse200WinnerLastSeasonCompetitorPlayersItemGender(_gender)
        ...
        get_season_info_response_200_winner_last_season_competitor_players_item = cls(
            id=id,
            name=name,
        ...
        return get_season_info_response_200_winner_last_season_competitor_players_item
