...
from ..models.get_sport_event_timeline_response_200_sport_event_sport_event_context_round_name import (
    GetSportEventTimelineResponse200SportEventSportEventContextRoundName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSportEventTimelineResponse200SportEventSportEventContextRound")


@_attrs_define
class GetSportEventTimelineResponse200SportEventSportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, GetSportEventTimelineResponse200SportEventSportEventContextRoundName]):
    ...
    name: Union[Unset, GetSportEventTimelineResponse200SportEventSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = GetSportEventTimelineResponse200SportEventSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        get_sport_event_timeline_response_200_sport_event_sport_event_context_round = cls(
        ...
        return get_sport_event_timeline_response_200_sport_event_sport_event_context_round
