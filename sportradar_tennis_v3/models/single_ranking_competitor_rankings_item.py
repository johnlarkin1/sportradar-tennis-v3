...
if TYPE_CHECKING:
    from ..models.single_ranking_competitor_rankings_item_competitor import (
        SingleRankingCompetitorRankingsItemCompetitor,
    )


T = TypeVar("T", bound="SingleRankingCompetitorRankingsItem")


@_attrs_define
class SingleRankingCompetitorRankingsItem:
    """
    Attributes:
        competitions_played (Union[Unset, int]):
        competitor (Union[Unset, SingleRankingCompetitorRankingsItemCompetitor]):
    ...
    competitor: Union[Unset, "SingleRankingCompetitorRankingsItemCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = SingleRankingCompetitorRankingsItemCompetitor.from_dict(_competitor)
        ...
        single_ranking_competitor_rankings_item = cls(
        ...
        return single_ranking_competitor_rankings_item
