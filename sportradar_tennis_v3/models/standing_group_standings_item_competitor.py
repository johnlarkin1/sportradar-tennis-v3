...
from ..models.standing_group_standings_item_competitor_gender import StandingGroupStandingsItemCompetitorGender
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.standing_group_standings_item_competitor_players_item import (
        StandingGroupStandingsItemCompetitorPlayersItem,
    )


T = TypeVar("T", bound="StandingGroupStandingsItemCompetitor")


@_attrs_define
class StandingGroupStandingsItemCompetitor:
    """
    Attributes:
        ...
        gender (Union[Unset, StandingGroupStandingsItemCompetitorGender]):
        players (Union[Unset, List['StandingGroupStandingsItemCompetitorPlayersItem']]):
    ...
    gender: Union[Unset, StandingGroupStandingsItemCompetitorGender] = UNSET
    players: Union[Unset, List["StandingGroupStandingsItemCompetitorPlayersItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = StandingGroupStandingsItemCompetitorGender(_gender)

        players = []
        _players = d.pop("players", UNSET)
        for players_item_data in _players or []:
            players_item = StandingGroupStandingsItemCompetitorPlayersItem.from_dict(players_item_data)
        ...
        standing_group_standings_item_competitor = cls(
            id=id,
            name=name,
        ...
        standing_group_standings_item_competitor.additional_properties = d
        return standing_group_standings_item_competitor
