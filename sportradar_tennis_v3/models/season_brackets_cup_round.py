...
if TYPE_CHECKING:
    from ..models.season_brackets_cup_round_linked_cup_rounds_item import SeasonBracketsCupRoundLinkedCupRoundsItem
    from ..models.season_brackets_cup_round_sport_events_item import SeasonBracketsCupRoundSportEventsItem


T = TypeVar("T", bound="SeasonBracketsCupRound")


@_attrs_define
class SeasonBracketsCupRound:
    """
    Attributes:
        id (str): Cup round id URN (sr:cup_round:x)
        linked_cup_rounds (Union[Unset, List['SeasonBracketsCupRoundLinkedCupRoundsItem']]):
        name (Union[Unset, str]): Name of round. Ex. quarterfinal
        order (Union[Unset, int]):
        sport_events (Union[Unset, List['SeasonBracketsCupRoundSportEventsItem']]):
    ...
    id: str
    linked_cup_rounds: Union[Unset, List["SeasonBracketsCupRoundLinkedCupRoundsItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    order: Union[Unset, int] = UNSET
    sport_events: Union[Unset, List["SeasonBracketsCupRoundSportEventsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for linked_cup_rounds_item_data in _linked_cup_rounds or []:
            linked_cup_rounds_item = SeasonBracketsCupRoundLinkedCupRoundsItem.from_dict(linked_cup_rounds_item_data)
        ...
        for sport_events_item_data in _sport_events or []:
            sport_events_item = SeasonBracketsCupRoundSportEventsItem.from_dict(sport_events_item_data)
        ...
        season_brackets_cup_round.additional_properties = d
        return season_brackets_cup_round
