...
from ..models.season_stage_group_competitors_item_players_item_gender import (
    SeasonStageGroupCompetitorsItemPlayersItemGender,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SeasonStageGroupCompetitorsItemPlayersItem")


@_attrs_define
class SeasonStageGroupCompetitorsItemPlayersItem:
    """
    Attributes:
        id (str):
        name (str):
        ...
        gender (Union[Unset, SeasonStageGroupCompetitorsItemPlayersItemGender]):
    ...
    gender: Union[Unset, SeasonStageGroupCompetitorsItemPlayersItemGender] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_gender, Unset):
            ...
            gender = SeasonStageGroupCompetitorsItemPlayersItemGender(_gender)
        ...
        season_stage_group_competitors_item_players_item = cls(
            id=id,
            name=name,
        ...
        return season_stage_group_competitors_item_players_item
