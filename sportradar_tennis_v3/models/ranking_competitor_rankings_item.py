...
if TYPE_CHECKING:
    from ..models.ranking_competitor_rankings_item_competitor import RankingCompetitorRankingsItemCompetitor


T = TypeVar("T", bound="RankingCompetitorRankingsItem")


@_attrs_define
class RankingCompetitorRankingsItem:
    """
    Attributes:
        competitions_played (Union[Unset, int]):
        competitor (Union[Unset, RankingCompetitorRankingsItemCompetitor]):
    ...
    competitor: Union[Unset, "RankingCompetitorRankingsItemCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = RankingCompetitorRankingsItemCompetitor.from_dict(_competitor)
        ...
        ranking_competitor_rankings_item = cls(
        ...
        return ranking_competitor_rankings_item
