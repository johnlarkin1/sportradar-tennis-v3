...
if TYPE_CHECKING:
    from ..models.sport_event_timeline_sport_event_status import SportEventTimelineSportEventStatus
    from ..models.sport_event_timeline_timeline_item import SportEventTimelineTimelineItem


T = TypeVar("T", bound="SportEventTimeline")
...
class SportEventTimeline:
    ...
    Attributes:
        ...
        sport_event_status (Union[Unset, SportEventTimelineSportEventStatus]):
        start_time (Union[Unset, datetime.datetime]):
        timeline (Union[Unset, List['SportEventTimelineTimelineItem']]):
    """

    id: Union[Unset, str] = UNSET
    sport_event_status: Union[Unset, "SportEventTimelineSportEventStatus"] = UNSET
    start_time: Union[Unset, datetime.datetime] = UNSET
    timeline: Union[Unset, List["SportEventTimelineTimelineItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sport_event_status, Unset):
            ...
            sport_event_status = SportEventTimelineSportEventStatus.from_dict(_sport_event_status)
        ...
        for timeline_item_data in _timeline or []:
            timeline_item = SportEventTimelineTimelineItem.from_dict(timeline_item_data)

            timeline.append(timeline_item)

        sport_event_timeline = cls(
            id=id,
