...
from ..models.summary_sport_event_status_match_status import SummarySportEventStatusMatchStatus
from ..models.summary_sport_event_status_status import SummarySportEventStatusStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.summary_sport_event_status_game_state import SummarySportEventStatusGameState
    from ..models.summary_sport_event_status_period_scores_item import SummarySportEventStatusPeriodScoresItem


T = TypeVar("T", bound="SummarySportEventStatus")


@_attrs_define
class SummarySportEventStatus:
    """
    Attributes:
        status (SummarySportEventStatusStatus):
        ...
        game_state (Union[Unset, SummarySportEventStatusGameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, SummarySportEventStatusMatchStatus]):
        period_scores (Union[Unset, List['SummarySportEventStatusPeriodScoresItem']]):
    ...
    game_state: Union[Unset, "SummarySportEventStatusGameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, SummarySportEventStatusMatchStatus] = UNSET
    period_scores: Union[Unset, List["SummarySportEventStatusPeriodScoresItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = SummarySportEventStatusStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = SummarySportEventStatusGameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = SummarySportEventStatusMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = SummarySportEventStatusPeriodScoresItem.from_dict(period_scores_item_data)
        ...
        summary_sport_event_status = cls(
            status=status,
        ...
        return summary_sport_event_status
