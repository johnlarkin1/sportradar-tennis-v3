...
from ...models.get_competitor_profile_response_200 import GetCompetitorProfileResponse200
...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/{locale}/competitors/{urn_competitor}/profile" + f".{format}",  # Append format to URL
    }
...
) -> Optional[GetCompetitorProfileResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetCompetitorProfileResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[GetCompetitorProfileResponse200]:
    return Response(
