...
from ...models.get_stream_events_event_id_item import GetStreamEventsEventIdItem
from ...models.get_stream_events_format import GetStreamEventsFormat
from ...models.get_stream_events_response_200_type_0 import GetStreamEventsResponse200Type0
from ...models.get_stream_events_response_200_type_1 import GetStreamEventsResponse200Type1
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    format_: Union[Unset, GetStreamEventsFormat] = UNSET,
    event_id: Union[Unset, List[GetStreamEventsEventIdItem]] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/stream/events/subscribe." + format,  # Append format directly if no path parameters
        "params": params,
    }
...
) -> Optional[Union["GetStreamEventsResponse200Type0", "GetStreamEventsResponse200Type1"]]:
    if response.status_code == HTTPStatus.OK:

        def _parse_response_200(
            data: object,
        ) -> Union["GetStreamEventsResponse200Type0", "GetStreamEventsResponse200Type1"]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_type_0 = GetStreamEventsResponse200Type0.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            response_200_type_1 = GetStreamEventsResponse200Type1.from_dict(data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union["GetStreamEventsResponse200Type0", "GetStreamEventsResponse200Type1"]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        format_ (Union[Unset, GetStreamEventsFormat]):
        event_id (Union[Unset, List[GetStreamEventsEventIdItem]]):
