...
if TYPE_CHECKING:
    from ..models.simple_season_stage_group import SimpleSeasonStageGroup
...
class SimpleTournamentMapping:
    ...
    Attributes:
        ...
        groups (Union[Unset, List['SimpleSeasonStageGroup']]):
    ...
    groups: Union[Unset, List["SimpleSeasonStageGroup"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = SimpleSeasonStageGroup.from_dict(groups_item_data)
