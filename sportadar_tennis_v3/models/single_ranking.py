...
if TYPE_CHECKING:
    from ..models.single_ranking_competitor import SingleRankingCompetitor
...
class SingleRanking:
    """
    Attributes:
        competitor_rankings (Union[Unset, List['SingleRankingCompetitor']]):
    ...
    competitor_rankings: Union[Unset, List["SingleRankingCompetitor"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for competitor_rankings_item_data in _competitor_rankings or []:
            competitor_rankings_item = SingleRankingCompetitor.from_dict(competitor_rankings_item_data)
