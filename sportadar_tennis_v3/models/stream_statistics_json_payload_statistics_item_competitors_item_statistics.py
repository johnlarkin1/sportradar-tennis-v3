...
T = TypeVar("T", bound="StreamStatisticsJsonPayloadStatisticsItemCompetitorsItemStatistics")


@_attrs_define
class StreamStatisticsJsonPayloadStatisticsItemCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stream_statistics_json_payload_statistics_item_competitors_item_statistics = cls(
            aces=aces,
        ...
        stream_statistics_json_payload_statistics_item_competitors_item_statistics.additional_properties = d
        return stream_statistics_json_payload_statistics_item_competitors_item_statistics
