...
T = TypeVar("T", bound="StreamStatisticsXmlPayloadStatisticsCompetitorsItemStatistics")


@_attrs_define
class StreamStatisticsXmlPayloadStatisticsCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stream_statistics_xml_payload_statistics_competitors_item_statistics = cls(
            aces=aces,
        ...
        stream_statistics_xml_payload_statistics_competitors_item_statistics.additional_properties = d
        return stream_statistics_xml_payload_statistics_competitors_item_statistics
