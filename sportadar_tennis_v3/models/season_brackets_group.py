...
if TYPE_CHECKING:
    from ..models.season_brackets_cup_round import SeasonBracketsCupRound
...
class SeasonBracketsGroup:
    ...
    Attributes:
        group_name (str):
        id (str):
        cup_rounds (Union[Unset, List['SeasonBracketsCupRound']]):
        order (Union[Unset, int]):
    """

    group_name: str
    id: str
    cup_rounds: Union[Unset, List["SeasonBracketsCupRound"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for cup_rounds_item_data in _cup_rounds or []:
            cup_rounds_item = SeasonBracketsCupRound.from_dict(cup_rounds_item_data)
