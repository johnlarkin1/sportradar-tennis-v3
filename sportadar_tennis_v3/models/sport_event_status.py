...
from ..models.enum_sport_event_match_status import EnumSportEventMatchStatus
from ..models.enum_sport_event_status import EnumSportEventStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.game_state import GameState
    from ..models.period_score import PeriodScore
...
class SportEventStatus:
    ...
    Attributes:
        ...
        game_state (Union[Unset, GameState]):
        home_normaltime_score (Union[Unset, int]):
        home_overtime_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        match_status (Union[Unset, EnumSportEventMatchStatus]):
        period_scores (Union[Unset, List['PeriodScore']]):
    ...
    game_state: Union[Unset, "GameState"] = UNSET
    home_normaltime_score: Union[Unset, int] = UNSET
    home_overtime_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    match_status: Union[Unset, EnumSportEventMatchStatus] = UNSET
    period_scores: Union[Unset, List["PeriodScore"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = EnumSportEventStatus(d.pop("status"))
        ...
        if isinstance(_game_state, Unset):
            ...
            game_state = GameState.from_dict(_game_state)
        ...
        if isinstance(_match_status, Unset):
            ...
            match_status = EnumSportEventMatchStatus(_match_status)

        period_scores = []
        _period_scores = d.pop("period_scores", UNSET)
        for period_scores_item_data in _period_scores or []:
            period_scores_item = PeriodScore.from_dict(period_scores_item_data)
