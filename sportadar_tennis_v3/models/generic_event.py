...
from ..models.enum_competitor_qualifier import EnumCompetitorQualifier
from ..models.enum_competitor_server_qualifier import EnumCompetitorServerQualifier
from ..models.enum_event_result import EnumEventResult
from ..models.enum_event_type import EnumEventType
from ..models.enum_suspended_reason import EnumSuspendedReason
...
class GenericEvent:
    ...
    Attributes:
        ...
        competitor (Union[Unset, EnumCompetitorQualifier]):
        ...
        reason (Union[Unset, EnumSuspendedReason]):
        result (Union[Unset, EnumEventResult]):
        server (Union[Unset, EnumCompetitorServerQualifier]):
    ...
    competitor: Union[Unset, EnumCompetitorQualifier] = UNSET
    first_serve_fault: Union[Unset, bool] = UNSET
    home_score: Union[Unset, int] = UNSET
    period: Union[Unset, str] = UNSET
    period_name: Union[Unset, str] = UNSET
    reason: Union[Unset, EnumSuspendedReason] = UNSET
    result: Union[Unset, EnumEventResult] = UNSET
    server: Union[Unset, EnumCompetitorServerQualifier] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = EnumCompetitorQualifier(_competitor)
        ...
        if isinstance(_reason, Unset):
            ...
            reason = EnumSuspendedReason(_reason)
        ...
        if isinstance(_result, Unset):
            ...
            result = EnumEventResult(_result)
        ...
        if isinstance(_server, Unset):
            ...
            server = EnumCompetitorServerQualifier(_server)
