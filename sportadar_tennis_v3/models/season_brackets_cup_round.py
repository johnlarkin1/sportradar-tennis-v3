...
if TYPE_CHECKING:
    from ..models.season_brackets_cup_round_linked import SeasonBracketsCupRoundLinked
    from ..models.season_brackets_cup_round_sport_event import SeasonBracketsCupRoundSportEvent
...
class SeasonBracketsCupRound:
    ...
    Attributes:
        ...
        linked_cup_rounds (Union[Unset, List['SeasonBracketsCupRoundLinked']]):
        name (Union[Unset, str]): Name of round. Ex. quarterfinal
        order (Union[Unset, int]):
        sport_events (Union[Unset, List['SeasonBracketsCupRoundSportEvent']]):
    ...
    id: str
    linked_cup_rounds: Union[Unset, List["SeasonBracketsCupRoundLinked"]] = UNSET
    name: Union[Unset, str] = UNSET
    order: Union[Unset, int] = UNSET
    sport_events: Union[Unset, List["SeasonBracketsCupRoundSportEvent"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for linked_cup_rounds_item_data in _linked_cup_rounds or []:
            linked_cup_rounds_item = SeasonBracketsCupRoundLinked.from_dict(linked_cup_rounds_item_data)
        ...
        for sport_events_item_data in _sport_events or []:
            sport_events_item = SeasonBracketsCupRoundSportEvent.from_dict(sport_events_item_data)
