...
if TYPE_CHECKING:
    ...
    from ..models.standing_competitor_comment import StandingCompetitorComment
...
class StandingCompetitor:
    """
    Attributes:
        comments (Union[Unset, List['StandingCompetitorComment']]):
    ...
    comments: Union[Unset, List["StandingCompetitorComment"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for comments_item_data in _comments or []:
            comments_item = StandingCompetitorComment.from_dict(comments_item_data)
