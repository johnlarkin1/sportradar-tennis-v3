...
if TYPE_CHECKING:
    from ..models.child_sport_event import ChildSportEvent
    from ..models.competitor import Competitor
    from ..models.coverage import Coverage
    from ..models.sport_event_context import SportEventContext
...
class SportEvent:
    ...
    Attributes:
        ...
        children (Union[Unset, List['ChildSportEvent']]):
        competitors (Union[Unset, List['Competitor']]):
        coverage (Union[Unset, Coverage]): Describes the expected coverage for different entities within this type. When
            type="sport_event" you will only get sport_event_properties. When type="competition" you will get
        ...
        sport_event_context (Union[Unset, SportEventContext]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for children_item_data in _children or []:
            children_item = ChildSportEvent.from_dict(children_item_data)
        ...
        coverage: Union[Unset, Coverage]
        if isinstance(_coverage, Unset):
            coverage = UNSET
        else:
            coverage = Coverage.from_dict(_coverage)
        ...
        if isinstance(_sport_event_context, Unset):
            ...
            sport_event_context = SportEventContext.from_dict(_sport_event_context)
