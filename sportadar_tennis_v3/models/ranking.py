...
if TYPE_CHECKING:
    from ..models.ranking_competitor import RankingCompetitor
...
class Ranking:
    """
    Attributes:
        competitor_rankings (Union[Unset, List['RankingCompetitor']]):
    ...
    competitor_rankings: Union[Unset, List["RankingCompetitor"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for competitor_rankings_item_data in _competitor_rankings or []:
            competitor_rankings_item = RankingCompetitor.from_dict(competitor_rankings_item_data)
