...
T = TypeVar("T", bound="SportEventCompetitorStatisticsStatistics")


@_attrs_define
class SportEventCompetitorStatisticsStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sport_event_competitor_statistics_statistics = cls(
            aces=aces,
        ...
        sport_event_competitor_statistics_statistics.additional_properties = d
        return sport_event_competitor_statistics_statistics
