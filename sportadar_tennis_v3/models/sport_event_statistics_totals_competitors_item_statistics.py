...
T = TypeVar("T", bound="SportEventStatisticsTotalsCompetitorsItemStatistics")


@_attrs_define
class SportEventStatisticsTotalsCompetitorsItemStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sport_event_statistics_totals_competitors_item_statistics = cls(
            aces=aces,
        ...
        sport_event_statistics_totals_competitors_item_statistics.additional_properties = d
        return sport_event_statistics_totals_competitors_item_statistics
