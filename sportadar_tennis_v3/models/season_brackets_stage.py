...
if TYPE_CHECKING:
    from ..models.season_brackets_group import SeasonBracketsGroup
...
class SeasonBracketsStage:
    ...
    Attributes:
        ...
        groups (Union[Unset, List['SeasonBracketsGroup']]):
    ...
    groups: Union[Unset, List["SeasonBracketsGroup"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = SeasonBracketsGroup.from_dict(groups_item_data)
