...
from ..models.enum_sport_event_context_round_name import EnumSportEventContextRoundName
from ..types import UNSET, Unset

T = TypeVar("T", bound="SportEventContextRound")


@_attrs_define
class SportEventContextRound:
    """
    Attributes:
        ...
        name (Union[Unset, EnumSportEventContextRoundName]):
    ...
    name: Union[Unset, EnumSportEventContextRoundName] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = EnumSportEventContextRoundName(_name)

        number = d.pop("number", UNSET)

        other_sport_event_id = d.pop("other_sport_event_id", UNSET)

        sport_event_context_round = cls(
        ...
        return sport_event_context_round
