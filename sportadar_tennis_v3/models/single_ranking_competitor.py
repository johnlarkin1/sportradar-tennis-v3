...
if TYPE_CHECKING:
    from ..models.basic_competitor import BasicCompetitor
...
class SingleRankingCompetitor:
    ...
    Attributes:
        ...
        competitor (Union[Unset, BasicCompetitor]):
    ...
    competitor: Union[Unset, "BasicCompetitor"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_competitor, Unset):
            ...
            competitor = BasicCompetitor.from_dict(_competitor)
