...
from ..models.coverage_sport_event_properties_scores import CoverageSportEventPropertiesScores
from ..types import UNSET, Unset

T = TypeVar("T", bound="CoverageSportEventProperties")


@_attrs_define
class CoverageSportEventProperties:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_scores, Unset):
            ...
            scores = CoverageSportEventPropertiesScores(_scores)

        coverage_sport_event_properties = cls(
        ...
        coverage_sport_event_properties.additional_properties = d
        return coverage_sport_event_properties
