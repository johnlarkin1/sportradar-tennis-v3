...
from ..models.enum_last_point_result import EnumLastPointResult
from ..models.enum_point_type import EnumPointType
...
class GameState:
    """
    Attributes:
        advantage (Union[Unset, EnumCompetitorQualifier]):
        away_score (Union[Unset, int]):
        home_score (Union[Unset, int]):
        last_point_result (Union[Unset, EnumLastPointResult]):
        point_type (Union[Unset, EnumPointType]):
        serving (Union[Unset, EnumCompetitorQualifier]):
        tie_break (Union[Unset, bool]):
    """

    advantage: Union[Unset, EnumCompetitorQualifier] = UNSET
    away_score: Union[Unset, int] = UNSET
    home_score: Union[Unset, int] = UNSET
    last_point_result: Union[Unset, EnumLastPointResult] = UNSET
    point_type: Union[Unset, EnumPointType] = UNSET
    serving: Union[Unset, EnumCompetitorQualifier] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_advantage, Unset):
            ...
            advantage = EnumCompetitorQualifier(_advantage)
        ...
        if isinstance(_last_point_result, Unset):
            ...
            last_point_result = EnumLastPointResult(_last_point_result)
        ...
        if isinstance(_point_type, Unset):
            ...
            point_type = EnumPointType(_point_type)
        ...
        if isinstance(_serving, Unset):
            ...
            serving = EnumCompetitorQualifier(_serving)
