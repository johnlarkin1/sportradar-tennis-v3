...
if TYPE_CHECKING:
    ...
    from ..models.sport_event_statistics_totals_competitors_item_statistics import (
        SportEventStatisticsTotalsCompetitorsItemStatistics,
    )


T = TypeVar("T", bound="SportEventStatisticsTotalsCompetitorsItem")


@_attrs_define
class SportEventStatisticsTotalsCompetitorsItem:
    """
    Attributes:
        ...
        statistics (Union[Unset, SportEventStatisticsTotalsCompetitorsItemStatistics]):
    ...
    statistics: Union[Unset, "SportEventStatisticsTotalsCompetitorsItemStatistics"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_statistics, Unset):
            ...
            statistics = SportEventStatisticsTotalsCompetitorsItemStatistics.from_dict(_statistics)

        virtual = d.pop("virtual", UNSET)

        sport_event_statistics_totals_competitors_item = cls(
            id=id,
            name=name,
        ...
        sport_event_statistics_totals_competitors_item.additional_properties = d
        return sport_event_statistics_totals_competitors_item
